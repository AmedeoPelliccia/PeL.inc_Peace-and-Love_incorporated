# BRX — Business Rules Exchange: WBS-300 Ground Segment (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-300 Ground Segment · **Accountable Q-Division:** Q-GROUND · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-300 — Ground Segment` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-SPACE | Q-GROUND | Ground station scheduling | → | XML | Q-GROUND (A) |
| 2 | Q-GROUND | Q-HPC | Uplink command sequences | → | XML | Q-GROUND (A) |
| 3 | Q-GROUND | Q-SCIRES | MCC autonomous ops concept | → | MD | Q-GROUND (A) |
