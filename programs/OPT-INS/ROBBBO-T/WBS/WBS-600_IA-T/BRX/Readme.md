# BRX — Business Rules Exchange: WBS-600 Integration, Assembly & Test (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-600 Integration, Assembly & Test · **Accountable Q-Division:** Q-INDUSTRY · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-600 — Integration, Assembly & Test` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-INDUSTRY | Q-SCIRES | AIT plan and flat-sat test procedures | → | MD | Q-INDUSTRY (A) |
