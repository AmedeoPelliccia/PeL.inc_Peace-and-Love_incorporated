# BRX — Business Rules Exchange: WBS-250 Avionics & Software (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-250 Avionics & Software · **Accountable Q-Division:** Q-HPC · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-250 — Avionics & Software` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-HPC | Q-SCIRES | SRS for autonomous operations | → | MD | Q-HPC (A) |
| 2 | Q-HPC | Q-SPACE | Data link protocol ICD | ↔ | YAML | Q-HPC (A) |
| 3 | Q-HPC | Q-DATAGOV | OBC telemetry schema | → | YAML | Q-HPC (A) |
| 4 | Q-HPC | Q-SCIRES | SW qualification report (ECSS-SW-80) | → | PDF | Q-HPC (A) |
