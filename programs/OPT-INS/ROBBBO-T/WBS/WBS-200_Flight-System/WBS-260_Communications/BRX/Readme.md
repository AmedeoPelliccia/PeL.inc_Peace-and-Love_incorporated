# BRX — Business Rules Exchange: WBS-260 Communications (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-260 Communications · **Accountable Q-Division:** Q-SPACE · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-260 — Communications` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-SPACE | Q-GROUND | Link budget (S-band TT&C, ISL) | → | PDF | Q-SPACE (A) |
| 2 | Q-SPACE | Q-HPC | Communications protocol ICD | ↔ | YAML | Q-SPACE (A) |
| 3 | Q-SPACE | AMPEL360-Q10/WBS-260 | COMMS relay service agreement | ↔ | MD | Q-SPACE (A) |
| 4 | Q-SPACE | GAIA/WBS-260 | Cross-platform ISL agreement | ↔ | MD | Q-SPACE (A) |
