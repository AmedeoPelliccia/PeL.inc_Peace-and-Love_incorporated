# BRX — Business Rules Exchange: WBS-200 Flight System (Platform Bus) (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-200 Flight System (Platform Bus) · **Accountable Q-Division:** Q-STRUCTURES · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-200 — Flight System (Platform Bus)` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-STRUCTURES | Q-MECHANICS, Q-HPC | Platform mass & power budget | ↔ | XLSX | Q-STRUCTURES (A) |
| 2 | Q-STRUCTURES | Q-SCIRES | Platform-level ICD | → | MD | Q-STRUCTURES (A) |
