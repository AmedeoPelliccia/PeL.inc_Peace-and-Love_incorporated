# BRX — Business Rules Exchange: WBS-220 Propulsion / RCS (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-220 Propulsion / RCS · **Accountable Q-Division:** Q-MECHANICS · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-220 — Propulsion / RCS` in the **ROBBBO-T** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-MECHANICS | Q-STRUCTURES | Thruster mass & envelope | → | XLSX | Q-MECHANICS (A) |
| 2 | Q-MECHANICS | Q-GREENTECH | Power demand (electric propulsion) | → | XLSX | Q-MECHANICS (A) |
| 3 | Q-MECHANICS | Q-HPC | Thruster firing commands ICD | ↔ | YAML | Q-MECHANICS (A) |
| 4 | Q-MECHANICS | Q-SCIRES | Delta-V budget | → | PDF | Q-MECHANICS (A) |
