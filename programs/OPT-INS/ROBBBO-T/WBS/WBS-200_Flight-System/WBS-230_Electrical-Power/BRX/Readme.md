# BRX — Business Rules Exchange: WBS-230 Electrical Power (ROBBBO-T)

**Product:** ROBBBO-T · **WBS:** WBS-230 Electrical Power · **Accountable Q-Division:** Q-GREENTECH · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-230 — Electrical Power` in the **ROBBBO-T** programme.
