# BRX — Business Rules Exchange: WBS-230 Electrical Power (AMPEL360-Q10)

**Product:** AMPEL360-Q10 · **WBS:** WBS-230 Electrical Power · **Accountable Q-Division:** Q-GREENTECH · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-230 — Electrical Power` in the **AMPEL360-Q10** programme.
...
| 4 | Q-GREENTECH | Q-SCIRES | Battery state-of-health report | → | PDF | Q-GREENTECH (A) |
