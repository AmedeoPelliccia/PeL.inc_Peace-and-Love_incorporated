# BRX — Business Rules Exchange: WBS-210 Structures & Mechanisms (AMPEL360-Q10)

**Product:** AMPEL360-Q10 · **WBS:** WBS-210 Structures & Mechanisms · **Accountable Q-Division:** Q-STRUCTURES · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-210 — Structures & Mechanisms` in the **AMPEL360-Q10** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-STRUCTURES | Q-MECHANICS | Structural interface load cases | → | PDF | Q-STRUCTURES (A) |
| 2 | Q-STRUCTURES | Q-MECHANICS | Separation mechanism ICD | ↔ | MD | Q-STRUCTURES (A) |
| 3 | Q-STRUCTURES | Q-INDUSTRY | FEM model (NASTRAN) | → | .bdf | Q-STRUCTURES (A) |
| 4 | Q-STRUCTURES | Q-SCIRES | Material qualification data | → | XLSX | Q-STRUCTURES (A) |
