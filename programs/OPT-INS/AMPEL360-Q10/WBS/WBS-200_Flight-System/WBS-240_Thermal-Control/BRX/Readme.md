# BRX — Business Rules Exchange: WBS-240 Thermal Control (AMPEL360-Q10)

**Product:** AMPEL360-Q10 · **WBS:** WBS-240 Thermal Control · **Accountable Q-Division:** Q-MECHANICS · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-240 — Thermal Control` in the **AMPEL360-Q10** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-MECHANICS | Q-STRUCTURES | TPS mechanical interface | ↔ | MD | Q-MECHANICS (A) |
...
| 4 | Q-MECHANICS | Q-SCIRES | Thermal analysis report (reentry) | → | PDF | Q-MECHANICS (A) |
