# BRX — Business Rules Exchange: WBS-700 Certification & Safety (AMPEL360-Q10)

**Product:** AMPEL360-Q10 · **WBS:** WBS-700 Certification & Safety · **Accountable Q-Division:** Q-SCIRES · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-700 — Certification & Safety` in the **AMPEL360-Q10** programme.
...
|---|----------|----------|-----------|-----------|--------|------------|
| 1 | Q-SCIRES | External (FAA/ESA) | Safety case dossier | → | PDF | Q-SCIRES (A) |
