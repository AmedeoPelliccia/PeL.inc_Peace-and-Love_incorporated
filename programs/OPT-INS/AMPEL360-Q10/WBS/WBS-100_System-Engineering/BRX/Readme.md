# BRX — Business Rules Exchange: WBS-100 System Engineering & Management (AMPEL360-Q10)

**Product:** AMPEL360-Q10 · **WBS:** WBS-100 System Engineering & Management · **Accountable Q-Division:** Q-SCIRES · **Status:** draft

## Purpose

This repository defines the **Business Rules Exchange (BRX)** for `WBS-100 — System Engineering & Management` in the **AMPEL360-Q10** programme.
...
| 5 | Q-SCIRES | ORB-PMO | Programme schedule baseline | → | XML | Q-SCIRES (A) |
