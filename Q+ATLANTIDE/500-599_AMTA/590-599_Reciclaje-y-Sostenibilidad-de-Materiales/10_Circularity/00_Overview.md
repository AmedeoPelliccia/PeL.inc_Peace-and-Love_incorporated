...
Overview of the *Circularity* subsection within the `590-599` code range (Section `09` — Reciclaje y Sostenibilidad de Materiales) of the AMTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Circularity*.

## Scope

- Covers the *Circularity* slice of the parent code range.
