...
Overview of the *laminados* subsection within the `500-509` code range (Section `00` — Materiales Compuestos Avanzados) of the AMTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *laminados*.

## Scope

- Covers the *laminados* slice of the parent code range.
