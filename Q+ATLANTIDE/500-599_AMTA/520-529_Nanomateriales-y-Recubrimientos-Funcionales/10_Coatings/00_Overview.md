...
Overview of the *Coatings* subsection within the `520-529` code range (Section `02` — Nanomateriales y Recubrimientos Funcionales) of the AMTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Coatings*.

## Scope

- Covers the *Coatings* slice of the parent code range.
