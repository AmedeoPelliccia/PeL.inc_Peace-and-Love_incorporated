...
Overview of the *anti-icing* subsection within the `520-529` code range (Section `02` — Nanomateriales y Recubrimientos Funcionales) of the AMTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *anti-icing*.

## Scope

- Covers the *anti-icing* slice of the parent code range.
