---
document_id: QATL-ATLAS-1000-OGATA-600-609-00-040-00-OVERVIEW
title: "OGATA 600-609 · 00.040.00 — safety"
register: ATLAS-1000
...
language: en
---
# OGATA 600-609 · Section 00 · Subsection 040 — safety

## 1. Purpose

Overview entry-point for the *safety* subsection within the `600-609` code range (Section `00` — *Robótica Industrial y Colaborativa*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 600-609.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *safety* slice of the parent code range `600-609`.
...
| Subsection | `040` — safety |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-INDUSTRY[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/600-609_Robotica-Industrial-y-Colaborativa/040_safety/` |
