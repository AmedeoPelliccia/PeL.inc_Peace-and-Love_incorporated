---
document_id: QATL-ATLAS-1000-OGATA-600-609-00-30-00-OVERVIEW
title: "OGATA 600-609 · 00.30.00 — automation cells"
register: ATLAS-1000
...
language: en
---
# OGATA 600-609 · Section 00 · Subsection 30 — automation cells
...
This subsubject (`00 Overview`) introduces the OGATA 600-609.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — automation cells |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-INDUSTRY[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/600-609_Robotica-Industrial-y-Colaborativa/30_automation-cells/` |
