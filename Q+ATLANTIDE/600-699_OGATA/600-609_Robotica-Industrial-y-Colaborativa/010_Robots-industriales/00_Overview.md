---
document_id: QATL-ATLAS-1000-OGATA-600-609-00-010-00-OVERVIEW
title: "OGATA 600-609 · 00.010.00 — Robots industriales"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Robots industriales"
subsubject: "00"
...
language: en
---
# OGATA 600-609 · Section 00 · Subsection 010 — Robots industriales

## 1. Purpose

Overview entry-point for the *Robots industriales* subsection within the `600-609` code range (Section `00` — *Robótica Industrial y Colaborativa*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 600-609.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Robots industriales* slice of the parent code range `600-609`.
...
| Subsection | `010` — Robots industriales |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-INDUSTRY[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/600-609_Robotica-Industrial-y-Colaborativa/010_Robots-industriales/` |
...
[^archtable]: **OGATA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `600-609` row (Section `00` — Robótica Industrial y Colaborativa, Primary Q-Division Q-INDUSTRY).
