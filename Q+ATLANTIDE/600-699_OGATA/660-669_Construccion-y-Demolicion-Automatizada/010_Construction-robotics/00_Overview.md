---
document_id: QATL-ATLAS-1000-OGATA-660-669-06-010-00-OVERVIEW
title: "OGATA 660-669 · 06.010.00 — Construction robotics"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Construction robotics"
subsubject: "00"
...
language: en
---
# OGATA 660-669 · Section 06 · Subsection 010 — Construction robotics

## 1. Purpose

Overview entry-point for the *Construction robotics* subsection within the `660-669` code range (Section `06` — *Construcción y Demolición Automatizada*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 660-669.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Construction robotics* slice of the parent code range `660-669`.
...
| Subsection | `010` — Construction robotics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/660-669_Construccion-y-Demolicion-Automatizada/010_Construction-robotics/` |
