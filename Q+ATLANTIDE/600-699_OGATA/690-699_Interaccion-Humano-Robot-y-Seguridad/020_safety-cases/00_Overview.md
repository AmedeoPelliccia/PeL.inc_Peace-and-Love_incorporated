---
document_id: QATL-ATLAS-1000-OGATA-690-699-09-020-00-OVERVIEW
title: "OGATA 690-699 · 09.020.00 — safety cases"
register: ATLAS-1000
...
language: en
---
# OGATA 690-699 · Section 09 · Subsection 020 — safety cases

## 1. Purpose

Overview entry-point for the *safety cases* subsection within the `690-699` code range (Section `09` — *Interacción Humano-Robot y Seguridad*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 690-699.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *safety cases* slice of the parent code range `690-699`.
...
| Folder path | `Q+ATLANTIDE/600-699_OGATA/690-699_Interaccion-Humano-Robot-y-Seguridad/020_safety-cases/` |
