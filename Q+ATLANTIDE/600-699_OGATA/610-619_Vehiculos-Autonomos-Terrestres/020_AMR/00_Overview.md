---
document_id: QATL-ATLAS-1000-OGATA-610-619-01-020-00-OVERVIEW
title: "OGATA 610-619 · 01.020.00 — AMR"
register: ATLAS-1000
...
language: en
---
# OGATA 610-619 · Section 01 · Subsection 020 — AMR

## 1. Purpose

Overview entry-point for the *AMR* subsection within the `610-619` code range (Section `01` — *Vehículos Autónomos Terrestres*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 610-619.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *AMR* slice of the parent code range `610-619`.
...
| Folder path | `Q+ATLANTIDE/600-699_OGATA/610-619_Vehiculos-Autonomos-Terrestres/020_AMR/` |
