---
document_id: QATL-ATLAS-1000-OGATA-610-619-01-030-00-OVERVIEW
title: "OGATA 610-619 · 01.030.00 — autonomous towing"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "autonomous towing"
subsubject: "00"
...
language: en
---
# OGATA 610-619 · Section 01 · Subsection 030 — autonomous towing

## 1. Purpose

Overview entry-point for the *autonomous towing* subsection within the `610-619` code range (Section `01` — *Vehículos Autónomos Terrestres*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 610-619.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *autonomous towing* slice of the parent code range `610-619`.
...
| Subsection | `030` — autonomous towing |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/610-619_Vehiculos-Autonomos-Terrestres/030_autonomous-towing/` |
