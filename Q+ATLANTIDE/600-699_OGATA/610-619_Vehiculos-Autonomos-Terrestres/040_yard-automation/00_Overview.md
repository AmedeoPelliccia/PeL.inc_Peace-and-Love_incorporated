---
document_id: QATL-ATLAS-1000-OGATA-610-619-01-040-00-OVERVIEW
title: "OGATA 610-619 · 01.040.00 — yard automation"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "yard automation"
subsubject: "00"
...
language: en
---
# OGATA 610-619 · Section 01 · Subsection 040 — yard automation

## 1. Purpose

Overview entry-point for the *yard automation* subsection within the `610-619` code range (Section `01` — *Vehículos Autónomos Terrestres*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 610-619.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *yard automation* slice of the parent code range `610-619`.
...
| Subsection | `040` — yard automation |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/610-619_Vehiculos-Autonomos-Terrestres/040_yard-automation/` |
