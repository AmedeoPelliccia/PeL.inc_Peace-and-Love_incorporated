---
document_id: QATL-ATLAS-1000-OGATA-650-659-05-20-00-OVERVIEW
title: "OGATA 650-659 · 05.20.00 — robotics"
register: ATLAS-1000
...
language: en
---
# OGATA 650-659 · Section 05 · Subsection 20 — robotics
...
This subsubject (`00 Overview`) introduces the OGATA 650-659.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — robotics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-CSR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/650-659_Agricultura-de-Precision/20_robotics/` |
