---
document_id: QATL-ATLAS-1000-OGATA-650-659-05-040-00-OVERVIEW
title: "OGATA 650-659 · 05.040.00 — autonomous farming systems"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "autonomous farming systems"
subsubject: "00"
...
language: en
---
# OGATA 650-659 · Section 05 · Subsection 040 — autonomous farming systems

## 1. Purpose

Overview entry-point for the *autonomous farming systems* subsection within the `650-659` code range (Section `05` — *Agricultura de Precisión*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 650-659.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *autonomous farming systems* slice of the parent code range `650-659`.
...
| Subsection | `040` — autonomous farming systems |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-CSR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/650-659_Agricultura-de-Precision/040_autonomous-farming-systems/` |
...
[^archtable]: **OGATA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `650-659` row (Section `05` — Agricultura de Precisión, Primary Q-Division Q-HORIZON).
