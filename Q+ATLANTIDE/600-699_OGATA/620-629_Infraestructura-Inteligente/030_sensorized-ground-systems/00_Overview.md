---
document_id: QATL-ATLAS-1000-OGATA-620-629-02-030-00-OVERVIEW
title: "OGATA 620-629 · 02.030.00 — sensorized ground systems"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "sensorized ground systems"
subsubject: "00"
...
language: en
---
# OGATA 620-629 · Section 02 · Subsection 030 — sensorized ground systems

## 1. Purpose

Overview entry-point for the *sensorized ground systems* subsection within the `620-629` code range (Section `02` — *Infraestructura Inteligente*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 620-629.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *sensorized ground systems* slice of the parent code range `620-629`.
...
| Subsection | `030` — sensorized ground systems |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/620-629_Infraestructura-Inteligente/030_sensorized-ground-systems/` |
...
[^archtable]: **OGATA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `620-629` row (Section `02` — Infraestructura Inteligente, Primary Q-Division Q-GROUND).
