---
document_id: QATL-ATLAS-1000-OGATA-620-629-02-020-00-OVERVIEW
title: "OGATA 620-629 · 02.020.00 — connected facilities"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "connected facilities"
subsubject: "00"
...
language: en
---
# OGATA 620-629 · Section 02 · Subsection 020 — connected facilities

## 1. Purpose

Overview entry-point for the *connected facilities* subsection within the `620-629` code range (Section `02` — *Infraestructura Inteligente*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 620-629.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *connected facilities* slice of the parent code range `620-629`.
...
| Subsection | `020` — connected facilities |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/620-629_Infraestructura-Inteligente/020_connected-facilities/` |
