---
document_id: QATL-ATLAS-1000-OGATA-680-689-08-10-00-OVERVIEW
title: "OGATA 680-689 · 08.10.00 — Scheduling"
register: ATLAS-1000
...
language: en
---
# OGATA 680-689 · Section 08 · Subsection 10 — Scheduling
...
This subsubject (`00 Overview`) introduces the OGATA 680-689.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `10` — Scheduling |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/680-689_Optimizacion-con-IA-y-Cuantica/10_Scheduling/` |
