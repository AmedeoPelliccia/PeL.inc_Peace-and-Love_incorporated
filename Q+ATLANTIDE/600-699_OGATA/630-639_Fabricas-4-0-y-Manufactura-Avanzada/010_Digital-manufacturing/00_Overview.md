---
document_id: QATL-ATLAS-1000-OGATA-630-639-03-010-00-OVERVIEW
title: "OGATA 630-639 · 03.010.00 — Digital manufacturing"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Digital manufacturing"
subsubject: "00"
...
language: en
---
# OGATA 630-639 · Section 03 · Subsection 010 — Digital manufacturing

## 1. Purpose

Overview entry-point for the *Digital manufacturing* subsection within the `630-639` code range (Section `03` — *Fábricas 4.0 y Manufactura Avanzada*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 630-639.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Digital manufacturing* slice of the parent code range `630-639`.
...
| Subsection | `010` — Digital manufacturing |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-INDUSTRY[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/630-639_Fabricas-4-0-y-Manufactura-Avanzada/010_Digital-manufacturing/` |
...
[^archtable]: **OGATA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `630-639` row (Section `03` — Fábricas 4.0 y Manufactura Avanzada, Primary Q-Division Q-INDUSTRY).
