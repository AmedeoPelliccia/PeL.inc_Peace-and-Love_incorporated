---
document_id: QATL-ATLAS-1000-OGATA-630-639-03-040-00-OVERVIEW
title: "OGATA 630-639 · 03.040.00 — robotics"
register: ATLAS-1000
...
language: en
---
# OGATA 630-639 · Section 03 · Subsection 040 — robotics

## 1. Purpose

Overview entry-point for the *robotics* subsection within the `630-639` code range (Section `03` — *Fábricas 4.0 y Manufactura Avanzada*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 630-639.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *robotics* slice of the parent code range `630-639`.
...
| Subsection | `040` — robotics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-INDUSTRY[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/630-639_Fabricas-4-0-y-Manufactura-Avanzada/040_robotics/` |
