---
document_id: QATL-ATLAS-1000-OGATA-670-679-07-20-00-OVERVIEW
title: "OGATA 670-679 · 07.20.00 — maintenance support"
register: ATLAS-1000
...
language: en
---
# OGATA 670-679 · Section 07 · Subsection 20 — maintenance support
...
This subsubject (`00 Overview`) introduces the OGATA 670-679.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — maintenance support |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/670-679_Servicios-Autonomos-en-Entornos-Cerrados/20_maintenance-support/` |
