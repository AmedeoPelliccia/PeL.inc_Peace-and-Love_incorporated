---
document_id: QATL-ATLAS-1000-OGATA-670-679-07-030-00-OVERVIEW
title: "OGATA 670-679 · 07.030.00 — facility service robots"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "facility service robots"
subsubject: "00"
...
language: en
---
# OGATA 670-679 · Section 07 · Subsection 030 — facility service robots

## 1. Purpose

Overview entry-point for the *facility service robots* subsection within the `670-679` code range (Section `07` — *Servicios Autónomos en Entornos Cerrados*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 670-679.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *facility service robots* slice of the parent code range `670-679`.
...
| Subsection | `030` — facility service robots |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/670-679_Servicios-Autonomos-en-Entornos-Cerrados/030_facility-service-robots/` |
...
[^archtable]: **OGATA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `670-679` row (Section `07` — Servicios Autónomos en Entornos Cerrados, Primary Q-Division Q-GROUND).
