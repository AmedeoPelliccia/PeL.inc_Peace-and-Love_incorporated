---
document_id: QATL-ATLAS-1000-OGATA-670-679-07-010-00-OVERVIEW
title: "OGATA 670-679 · 07.010.00 — Indoor robotics"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Indoor robotics"
subsubject: "00"
...
language: en
---
# OGATA 670-679 · Section 07 · Subsection 010 — Indoor robotics

## 1. Purpose

Overview entry-point for the *Indoor robotics* subsection within the `670-679` code range (Section `07` — *Servicios Autónomos en Entornos Cerrados*) of the **OGATA** architecture band (*On-Ground Automation Technology Architecture*, master range `600–699`).

This subsubject (`00 Overview`) introduces the OGATA 670-679.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Indoor robotics* slice of the parent code range `670-679`.
...
| Subsection | `010` — Indoor robotics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/600-699_OGATA/670-679_Servicios-Autonomos-en-Entornos-Cerrados/010_Indoor-robotics/` |
