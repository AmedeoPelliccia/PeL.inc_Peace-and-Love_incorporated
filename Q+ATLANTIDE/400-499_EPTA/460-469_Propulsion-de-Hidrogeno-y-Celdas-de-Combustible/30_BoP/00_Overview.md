...
Overview of the *BoP* subsection within the `460-469` code range (Section `06` — Propulsión de Hidrógeno y Celdas de Combustible) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *BoP*.

## Scope

- Covers the *BoP* slice of the parent code range.
