---
document_id: QATL-ATLAS-1000-EPTA-420-429-02-10-00-OVERVIEW
title: "EPTA 420-429 · 02.10.00 — Baterías"
register: ATLAS-1000
...
language: en
---
# EPTA 420-429 · Section 02 · Subsection 10 — Baterías
...
This subsubject (`00 Overview`) introduces the EPTA 420-429.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `10` — Baterías |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-STRUCTURES, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/420-429_Almacenamiento-de-Energia/10_Baterias/` |
