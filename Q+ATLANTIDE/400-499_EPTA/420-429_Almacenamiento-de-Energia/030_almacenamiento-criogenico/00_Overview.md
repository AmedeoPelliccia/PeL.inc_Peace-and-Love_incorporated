---
document_id: QATL-ATLAS-1000-EPTA-420-429-02-030-00-OVERVIEW
title: "EPTA 420-429 · 02.030.00 — almacenamiento criogénico"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "almacenamiento criogénico"
subsubject: "00"
...
language: en
---
# EPTA 420-429 · Section 02 · Subsection 030 — almacenamiento criogénico

## 1. Purpose

Overview entry-point for the *almacenamiento criogénico* subsection within the `420-429` code range (Section `02` — *Almacenamiento de Energía*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 420-429.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *almacenamiento criogénico* slice of the parent code range `420-429`.
...
| Subsection | `030` — almacenamiento criogénico |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-STRUCTURES, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/420-429_Almacenamiento-de-Energia/030_almacenamiento-criogenico/` |
