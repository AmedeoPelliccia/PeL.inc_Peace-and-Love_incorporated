---
document_id: QATL-ATLAS-1000-EPTA-470-479-07-010-00-OVERVIEW
title: "EPTA 470-479 · 07.010.00 — Propulsión avanzada"
register: ATLAS-1000
...
language: en
---
# EPTA 470-479 · Section 07 · Subsection 010 — Propulsión avanzada

## 1. Purpose

Overview entry-point for the *Propulsión avanzada* subsection within the `470-479` code range (Section `07` — *Nuevas Formas de Propulsión*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 470-479.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Propulsión avanzada* slice of the parent code range `470-479`.
...
| Subsection | `010` — Propulsión avanzada |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-HPC, Q-SPACE |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/470-479_Nuevas-Formas-de-Propulsion/010_Propulsion-avanzada/` |
