...
Overview of the *HVDC* subsection within the `430-439` code range (Section `03` — Gestión y Distribución de Energía) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *HVDC*.

## Scope

- Covers the *HVDC* slice of the parent code range.
