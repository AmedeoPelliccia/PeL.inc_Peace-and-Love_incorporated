---
document_id: QATL-ATLAS-1000-EPTA-430-439-03-020-00-OVERVIEW
title: "EPTA 430-439 · 03.020.00 — power management"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "power management"
subsubject: "00"
...
language: en
---
# EPTA 430-439 · Section 03 · Subsection 020 — power management

## 1. Purpose

Overview entry-point for the *power management* subsection within the `430-439` code range (Section `03` — *Gestión y Distribución de Energía*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 430-439.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *power management* slice of the parent code range `430-439`.
...
| Subsection | `020` — power management |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-MECHANICS, Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/430-439_Gestion-y-Distribucion-de-Energia/020_power-management/` |
