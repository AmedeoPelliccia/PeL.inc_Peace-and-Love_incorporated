---
document_id: QATL-ATLAS-1000-EPTA-430-439-03-030-00-OVERVIEW
title: "EPTA 430-439 · 03.030.00 — distribución"
register: ATLAS-1000
...
language: en
---
# EPTA 430-439 · Section 03 · Subsection 030 — distribución

## 1. Purpose

Overview entry-point for the *distribución* subsection within the `430-439` code range (Section `03` — *Gestión y Distribución de Energía*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 430-439.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *distribución* slice of the parent code range `430-439`.
...
| Subsection | `030` — distribución |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-MECHANICS, Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/430-439_Gestion-y-Distribucion-de-Energia/030_distribucion/` |
