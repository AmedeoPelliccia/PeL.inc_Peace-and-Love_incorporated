---
document_id: QATL-ATLAS-1000-EPTA-430-439-03-40-00-OVERVIEW
title: "EPTA 430-439 · 03.40.00 — protección eléctrica"
register: ATLAS-1000
...
language: en
---
# EPTA 430-439 · Section 03 · Subsection 40 — protección eléctrica
...
This subsubject (`00 Overview`) introduces the EPTA 430-439.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — protección eléctrica |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-MECHANICS, Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/430-439_Gestion-y-Distribucion-de-Energia/40_proteccion-electrica/` |
