...
Overview of the *power management* subsection within the `430-439` code range (Section `03` — Gestión y Distribución de Energía) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *power management*.

## Scope

- Covers the *power management* slice of the parent code range.
