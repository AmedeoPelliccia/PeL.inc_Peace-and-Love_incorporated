---
document_id: QATL-ATLAS-1000-EPTA-430-439-03-010-00-OVERVIEW
title: "EPTA 430-439 · 03.010.00 — HVDC"
register: ATLAS-1000
...
language: en
---
# EPTA 430-439 · Section 03 · Subsection 010 — HVDC

## 1. Purpose

Overview entry-point for the *HVDC* subsection within the `430-439` code range (Section `03` — *Gestión y Distribución de Energía*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 430-439.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *HVDC* slice of the parent code range `430-439`.
...
| Folder path | `Q+ATLANTIDE/400-499_EPTA/430-439_Gestion-y-Distribucion-de-Energia/010_HVDC/` |
