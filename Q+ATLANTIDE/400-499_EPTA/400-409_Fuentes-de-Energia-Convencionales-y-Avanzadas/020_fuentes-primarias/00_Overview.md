---
document_id: QATL-ATLAS-1000-EPTA-400-409-00-020-00-OVERVIEW
title: "EPTA 400-409 · 00.020.00 — fuentes primarias"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "fuentes primarias"
subsubject: "00"
...
language: en
---
# EPTA 400-409 · Section 00 · Subsection 020 — fuentes primarias

## 1. Purpose

Overview entry-point for the *fuentes primarias* subsection within the `400-409` code range (Section `00` — *Fuentes de Energía Convencionales y Avanzadas*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 400-409.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *fuentes primarias* slice of the parent code range `400-409`.
...
| Subsection | `020` — fuentes primarias |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/400-409_Fuentes-de-Energia-Convencionales-y-Avanzadas/020_fuentes-primarias/` |
