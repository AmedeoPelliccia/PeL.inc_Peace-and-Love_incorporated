---
document_id: QATL-ATLAS-1000-EPTA-440-449-04-030-00-OVERVIEW
title: "EPTA 440-449 · 04.030.00 — hot section"
register: ATLAS-1000
...
language: en
---
# EPTA 440-449 · Section 04 · Subsection 030 — hot section

## 1. Purpose

Overview entry-point for the *hot section* subsection within the `440-449` code range (Section `04` — *Propulsión por Combustión*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 440-449.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *hot section* slice of the parent code range `440-449`.
...
| Subsection | `030` — hot section |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/440-449_Propulsion-por-Combustion/030_hot-section/` |
