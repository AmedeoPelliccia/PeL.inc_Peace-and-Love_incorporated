...
Overview of the *combustión* subsection within the `440-449` code range (Section `04` — Propulsión por Combustión) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *combustión*.

## Scope

- Covers the *combustión* slice of the parent code range.
