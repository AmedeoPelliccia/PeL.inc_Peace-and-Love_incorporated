---
document_id: QATL-ATLAS-1000-EPTA-440-449-04-20-00-OVERVIEW
title: "EPTA 440-449 · 04.20.00 — combustión"
register: ATLAS-1000
...
language: en
---
# EPTA 440-449 · Section 04 · Subsection 20 — combustión
...
This subsubject (`00 Overview`) introduces the EPTA 440-449.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — combustión |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/440-449_Propulsion-por-Combustion/20_combustion/` |
