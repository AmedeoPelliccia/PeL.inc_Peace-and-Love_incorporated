---
document_id: QATL-ATLAS-1000-EPTA-440-449-04-040-00-OVERVIEW
title: "EPTA 440-449 · 04.040.00 — combustibles sostenibles"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "combustibles sostenibles"
subsubject: "00"
...
language: en
---
# EPTA 440-449 · Section 04 · Subsection 040 — combustibles sostenibles

## 1. Purpose

Overview entry-point for the *combustibles sostenibles* subsection within the `440-449` code range (Section `04` — *Propulsión por Combustión*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 440-449.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *combustibles sostenibles* slice of the parent code range `440-449`.
...
| Subsection | `040` — combustibles sostenibles |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/440-449_Propulsion-por-Combustion/040_combustibles-sostenibles/` |
...
[^archtable]: **EPTA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `440-449` row (Section `04` — Propulsión por Combustión, Primary Q-Division Q-GREENTECH).
