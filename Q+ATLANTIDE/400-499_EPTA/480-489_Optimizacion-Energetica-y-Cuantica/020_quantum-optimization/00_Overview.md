---
document_id: QATL-ATLAS-1000-EPTA-480-489-08-020-00-OVERVIEW
title: "EPTA 480-489 · 08.020.00 — quantum optimization"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "quantum optimization"
subsubject: "00"
...
language: en
---
# EPTA 480-489 · Section 08 · Subsection 020 — quantum optimization

## 1. Purpose

Overview entry-point for the *quantum optimization* subsection within the `480-489` code range (Section `08` — *Optimización Energética y Cuántica*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 480-489.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *quantum optimization* slice of the parent code range `480-489`.
...
| Subsection | `020` — quantum optimization |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-HORIZON |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/480-489_Optimizacion-Energetica-y-Cuantica/020_quantum-optimization/` |
