---
document_id: QATL-ATLAS-1000-EPTA-480-489-08-20-00-OVERVIEW
title: "EPTA 480-489 · 08.20.00 — quantum optimization"
register: ATLAS-1000
...
language: en
---
# EPTA 480-489 · Section 08 · Subsection 20 — quantum optimization
...
This subsubject (`00 Overview`) introduces the EPTA 480-489.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — quantum optimization |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-HORIZON |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/480-489_Optimizacion-Energetica-y-Cuantica/20_quantum-optimization/` |
