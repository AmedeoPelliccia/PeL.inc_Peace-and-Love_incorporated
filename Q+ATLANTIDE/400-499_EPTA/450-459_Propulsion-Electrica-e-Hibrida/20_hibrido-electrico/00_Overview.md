...
Overview of the *híbrido-eléctrico* subsection within the `450-459` code range (Section `05` — Propulsión Eléctrica e Híbrida) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *híbrido-eléctrico*.

## Scope

- Covers the *híbrido-eléctrico* slice of the parent code range.
