...
Overview of the *inversores* subsection within the `450-459` code range (Section `05` — Propulsión Eléctrica e Híbrida) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *inversores*.

## Scope

- Covers the *inversores* slice of the parent code range.
