---
document_id: QATL-ATLAS-1000-EPTA-450-459-05-30-00-OVERVIEW
title: "EPTA 450-459 · 05.30.00 — conversión"
register: ATLAS-1000
...
language: en
---
# EPTA 450-459 · Section 05 · Subsection 30 — conversión
...
This subsubject (`00 Overview`) introduces the EPTA 450-459.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — conversión |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-MECHANICS, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/400-499_EPTA/450-459_Propulsion-Electrica-e-Hibrida/30_conversion/` |
