---
document_id: QATL-ATLAS-1000-EPTA-410-419-01-020-00-OVERVIEW
title: "EPTA 410-419 · 01.020.00 — eólica"
register: ATLAS-1000
...
language: en
---
# EPTA 410-419 · Section 01 · Subsection 020 — eólica

## 1. Purpose

Overview entry-point for the *eólica* subsection within the `410-419` code range (Section `01` — *Energías Renovables*) of the **EPTA** architecture band (*Energy & Propulsion Technology Architecture*, master range `400–499`).

This subsubject (`00 Overview`) introduces the EPTA 410-419.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *eólica* slice of the parent code range `410-419`.
