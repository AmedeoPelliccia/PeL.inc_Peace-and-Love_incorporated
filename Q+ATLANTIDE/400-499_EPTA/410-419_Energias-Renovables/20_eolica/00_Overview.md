...
Overview of the *eólica* subsection within the `410-419` code range (Section `01` — Energías Renovables) of the EPTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *eólica*.

## Scope

- Covers the *eólica* slice of the parent code range.
