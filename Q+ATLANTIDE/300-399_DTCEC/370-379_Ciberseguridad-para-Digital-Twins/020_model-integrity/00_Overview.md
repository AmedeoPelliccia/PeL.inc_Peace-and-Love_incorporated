---
document_id: QATL-ATLAS-1000-DTCEC-370-379-07-020-00-OVERVIEW
title: "DTCEC 370-379 · 07.020.00 — model integrity"
register: ATLAS-1000
...
language: en
---
# DTCEC 370-379 · Section 07 · Subsection 020 — model integrity
...
This subsubject (`00 Overview`) introduces the DTCEC 370-379.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `020` — model integrity |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-SPACE |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/370-379_Ciberseguridad-para-Digital-Twins/020_model-integrity/` |
