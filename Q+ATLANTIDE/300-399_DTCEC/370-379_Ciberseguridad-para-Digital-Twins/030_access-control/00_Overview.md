---
document_id: QATL-ATLAS-1000-DTCEC-370-379-07-030-00-OVERVIEW
title: "DTCEC 370-379 · 07.030.00 — access control"
register: ATLAS-1000
...
language: en
---
# DTCEC 370-379 · Section 07 · Subsection 030 — access control

## 1. Purpose

Overview entry-point for the *access control* subsection within the `370-379` code range (Section `07` — *Ciberseguridad para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 370-379.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *access control* slice of the parent code range `370-379`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/370-379_Ciberseguridad-para-Digital-Twins/030_access-control/` |
