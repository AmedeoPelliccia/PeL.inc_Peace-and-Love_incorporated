---
document_id: QATL-ATLAS-1000-DTCEC-370-379-07-10-00-OVERVIEW
title: "DTCEC 370-379 · 07.10.00 — Security-by-design"
register: ATLAS-1000
...
language: en
---
# DTCEC 370-379 · Section 07 · Subsection 10 — Security-by-design
...
This subsubject (`00 Overview`) introduces the DTCEC 370-379.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `10` — Security-by-design |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-SPACE |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/370-379_Ciberseguridad-para-Digital-Twins/10_Security-by-design/` |
