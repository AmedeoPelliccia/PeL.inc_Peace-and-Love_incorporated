---
document_id: QATL-ATLAS-1000-DTCEC-370-379-07-040-00-OVERVIEW
title: "DTCEC 370-379 · 07.040.00 — cyber resilience"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "cyber resilience"
subsubject: "00"
...
language: en
---
# DTCEC 370-379 · Section 07 · Subsection 040 — cyber resilience

## 1. Purpose

Overview entry-point for the *cyber resilience* subsection within the `370-379` code range (Section `07` — *Ciberseguridad para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 370-379.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *cyber resilience* slice of the parent code range `370-379`.
...
| Subsection | `040` — cyber resilience |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-SPACE |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/370-379_Ciberseguridad-para-Digital-Twins/040_cyber-resilience/` |
