---
document_id: QATL-ATLAS-1000-DTCEC-360-369-06-020-00-OVERVIEW
title: "DTCEC 360-369 · 06.020.00 — traceability ledger"
register: ATLAS-1000
...
code_range: "360-369"
section: "06"
section_title: "Blockchain y Tecnologías Descentralizadas"
subject: "00"
subject_title: "General Information"
subsection: "020"
subsection_title: "traceability ledger"
subsubject: "00"
...
language: en
---
# DTCEC 360-369 · Section 06 · Subsection 020 — traceability ledger

## 1. Purpose

Overview entry-point for the *traceability ledger* subsection within the `360-369` code range (Section `06` — *Blockchain y Tecnologías Descentralizadas*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 360-369.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *traceability ledger* slice of the parent code range `360-369`.
...
| Code range | `360-369` |
| Section | `06` — Blockchain y Tecnologías Descentralizadas |
| Subject | `00` — General Information |
| Subsection | `020` — traceability ledger |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/360-369_Blockchain-y-Tecnologias-Descentralizadas/020_traceability-ledger/` |
...
[^archtable]: **DTCEC §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `360-369` row (Section `06` — Blockchain y Tecnologías Descentralizadas, Primary Q-Division Q-DATAGOV).
