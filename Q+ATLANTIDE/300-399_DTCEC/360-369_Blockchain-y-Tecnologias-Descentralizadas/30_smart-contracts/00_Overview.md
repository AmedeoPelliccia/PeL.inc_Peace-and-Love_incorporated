---
document_id: QATL-ATLAS-1000-DTCEC-360-369-06-30-00-OVERVIEW
title: "DTCEC 360-369 · 06.30.00 — smart contracts"
register: ATLAS-1000
...
language: en
---
# DTCEC 360-369 · Section 06 · Subsection 30 — smart contracts
...
This subsubject (`00 Overview`) introduces the DTCEC 360-369.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — smart contracts |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/360-369_Blockchain-y-Tecnologias-Descentralizadas/30_smart-contracts/` |
