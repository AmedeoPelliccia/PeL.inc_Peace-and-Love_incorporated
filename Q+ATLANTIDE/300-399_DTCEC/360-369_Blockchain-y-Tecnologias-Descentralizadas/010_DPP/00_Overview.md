---
document_id: QATL-ATLAS-1000-DTCEC-360-369-06-010-00-OVERVIEW
title: "DTCEC 360-369 · 06.010.00 — DPP"
register: ATLAS-1000
...
language: en
---
# DTCEC 360-369 · Section 06 · Subsection 010 — DPP

## 1. Purpose

Overview entry-point for the *DPP* subsection within the `360-369` code range (Section `06` — *Blockchain y Tecnologías Descentralizadas*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 360-369.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *DPP* slice of the parent code range `360-369`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/360-369_Blockchain-y-Tecnologias-Descentralizadas/010_DPP/` |
