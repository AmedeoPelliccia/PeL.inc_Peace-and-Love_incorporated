---
document_id: QATL-ATLAS-1000-DTCEC-300-309-00-40-00-OVERVIEW
title: "DTCEC 300-309 · 00.40.00 — configuración"
register: ATLAS-1000
...
language: en
---
# DTCEC 300-309 · Section 00 · Subsection 40 — configuración
...
This subsubject (`00 Overview`) introduces the DTCEC 300-309.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — configuración |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/300-309_Fundamentos-de-Gemelos-Digitales/40_configuracion/` |
