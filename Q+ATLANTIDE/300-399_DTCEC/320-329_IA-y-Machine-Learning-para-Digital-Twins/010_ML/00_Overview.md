---
document_id: QATL-ATLAS-1000-DTCEC-320-329-02-010-00-OVERVIEW
title: "DTCEC 320-329 · 02.010.00 — ML"
register: ATLAS-1000
...
language: en
---
# DTCEC 320-329 · Section 02 · Subsection 010 — ML

## 1. Purpose

Overview entry-point for the *ML* subsection within the `320-329` code range (Section `02` — *IA y Machine Learning para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 320-329.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *ML* slice of the parent code range `320-329`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/320-329_IA-y-Machine-Learning-para-Digital-Twins/010_ML/` |
