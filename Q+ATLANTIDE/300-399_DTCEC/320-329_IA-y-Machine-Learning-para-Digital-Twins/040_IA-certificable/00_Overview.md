---
document_id: QATL-ATLAS-1000-DTCEC-320-329-02-040-00-OVERVIEW
title: "DTCEC 320-329 · 02.040.00 — IA certificable"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "IA certificable"
subsubject: "00"
...
language: en
---
# DTCEC 320-329 · Section 02 · Subsection 040 — IA certificable

## 1. Purpose

Overview entry-point for the *IA certificable* subsection within the `320-329` code range (Section `02` — *IA y Machine Learning para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 320-329.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *IA certificable* slice of the parent code range `320-329`.
...
| Subsection | `040` — IA certificable |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-AIR, Q-GREENTECH |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/320-329_IA-y-Machine-Learning-para-Digital-Twins/040_IA-certificable/` |
