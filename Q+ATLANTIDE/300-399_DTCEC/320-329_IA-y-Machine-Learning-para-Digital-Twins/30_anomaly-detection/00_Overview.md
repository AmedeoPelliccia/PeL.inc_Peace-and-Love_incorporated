---
document_id: QATL-ATLAS-1000-DTCEC-320-329-02-30-00-OVERVIEW
title: "DTCEC 320-329 · 02.30.00 — anomaly detection"
register: ATLAS-1000
...
language: en
---
# DTCEC 320-329 · Section 02 · Subsection 30 — anomaly detection
...
This subsubject (`00 Overview`) introduces the DTCEC 320-329.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — anomaly detection |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-AIR, Q-GREENTECH |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/320-329_IA-y-Machine-Learning-para-Digital-Twins/30_anomaly-detection/` |
