---
document_id: QATL-ATLAS-1000-DTCEC-350-359-05-40-00-OVERVIEW
title: "DTCEC 350-359 · 05.40.00 — virtual operations"
register: ATLAS-1000
...
language: en
---
# DTCEC 350-359 · Section 05 · Subsection 40 — virtual operations
...
This subsubject (`00 Overview`) introduces the DTCEC 350-359.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — virtual operations |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-GROUND |
| ORB support | ORB-HR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/350-359_Realidad-Extendida-y-Metaverso/40_virtual-operations/` |
