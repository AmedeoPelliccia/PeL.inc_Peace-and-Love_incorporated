...
Overview of the *training* subsection within the `350-359` code range (Section `05` — Realidad Extendida y Metaverso) of the DTCEC architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *training*.

## Scope

- Covers the *training* slice of the parent code range.
