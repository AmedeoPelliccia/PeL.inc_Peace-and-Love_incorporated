---
document_id: QATL-ATLAS-1000-DTCEC-350-359-05-030-00-OVERVIEW
title: "DTCEC 350-359 · 05.030.00 — immersive IETP"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "immersive IETP"
subsubject: "00"
...
language: en
---
# DTCEC 350-359 · Section 05 · Subsection 030 — immersive IETP

## 1. Purpose

Overview entry-point for the *immersive IETP* subsection within the `350-359` code range (Section `05` — *Realidad Extendida y Metaverso*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 350-359.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *immersive IETP* slice of the parent code range `350-359`.
...
| Subsection | `030` — immersive IETP |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-GROUND |
| ORB support | ORB-HR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/350-359_Realidad-Extendida-y-Metaverso/030_immersive-IETP/` |
