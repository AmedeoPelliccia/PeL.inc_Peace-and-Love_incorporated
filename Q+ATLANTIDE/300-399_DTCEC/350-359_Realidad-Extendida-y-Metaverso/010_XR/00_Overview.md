---
document_id: QATL-ATLAS-1000-DTCEC-350-359-05-010-00-OVERVIEW
title: "DTCEC 350-359 · 05.010.00 — XR"
register: ATLAS-1000
...
language: en
---
# DTCEC 350-359 · Section 05 · Subsection 010 — XR

## 1. Purpose

Overview entry-point for the *XR* subsection within the `350-359` code range (Section `05` — *Realidad Extendida y Metaverso*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 350-359.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *XR* slice of the parent code range `350-359`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/350-359_Realidad-Extendida-y-Metaverso/010_XR/` |
