---
document_id: QATL-ATLAS-1000-DTCEC-350-359-05-020-00-OVERVIEW
title: "DTCEC 350-359 · 05.020.00 — training"
register: ATLAS-1000
...
language: en
---
# DTCEC 350-359 · Section 05 · Subsection 020 — training

## 1. Purpose

Overview entry-point for the *training* subsection within the `350-359` code range (Section `05` — *Realidad Extendida y Metaverso*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 350-359.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *training* slice of the parent code range `350-359`.
...
| Subsection | `020` — training |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-GROUND |
| ORB support | ORB-HR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/350-359_Realidad-Extendida-y-Metaverso/020_training/` |
