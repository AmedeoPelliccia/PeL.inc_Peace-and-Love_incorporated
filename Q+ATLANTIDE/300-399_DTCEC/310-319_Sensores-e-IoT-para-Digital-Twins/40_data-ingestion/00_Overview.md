---
document_id: QATL-ATLAS-1000-DTCEC-310-319-01-40-00-OVERVIEW
title: "DTCEC 310-319 · 01.40.00 — data ingestion"
register: ATLAS-1000
...
language: en
---
# DTCEC 310-319 · Section 01 · Subsection 40 — data ingestion
...
This subsubject (`00 Overview`) introduces the DTCEC 310-319.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — data ingestion |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-MECHANICS, Q-SPACE |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/310-319_Sensores-e-IoT-para-Digital-Twins/40_data-ingestion/` |
