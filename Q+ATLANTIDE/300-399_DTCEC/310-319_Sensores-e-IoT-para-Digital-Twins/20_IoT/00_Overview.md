...
Overview of the *IoT* subsection within the `310-319` code range (Section `01` — Sensores e IoT para Digital Twins) of the DTCEC architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *IoT*.

## Scope

- Covers the *IoT* slice of the parent code range.
