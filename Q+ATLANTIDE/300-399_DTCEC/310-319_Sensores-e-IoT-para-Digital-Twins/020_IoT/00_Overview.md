---
document_id: QATL-ATLAS-1000-DTCEC-310-319-01-020-00-OVERVIEW
title: "DTCEC 310-319 · 01.020.00 — IoT"
register: ATLAS-1000
...
language: en
---
# DTCEC 310-319 · Section 01 · Subsection 020 — IoT

## 1. Purpose

Overview entry-point for the *IoT* subsection within the `310-319` code range (Section `01` — *Sensores e IoT para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 310-319.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *IoT* slice of the parent code range `310-319`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/310-319_Sensores-e-IoT-para-Digital-Twins/020_IoT/` |
