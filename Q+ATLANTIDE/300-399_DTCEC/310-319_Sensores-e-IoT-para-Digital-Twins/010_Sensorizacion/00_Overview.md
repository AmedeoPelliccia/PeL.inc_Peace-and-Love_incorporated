---
document_id: QATL-ATLAS-1000-DTCEC-310-319-01-010-00-OVERVIEW
title: "DTCEC 310-319 · 01.010.00 — Sensorización"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Sensorización"
subsubject: "00"
...
language: en
---
# DTCEC 310-319 · Section 01 · Subsection 010 — Sensorización

## 1. Purpose

Overview entry-point for the *Sensorización* subsection within the `310-319` code range (Section `01` — *Sensores e IoT para Digital Twins*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 310-319.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Sensorización* slice of the parent code range `310-319`.
...
| Subsection | `010` — Sensorización |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-MECHANICS, Q-SPACE |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/310-319_Sensores-e-IoT-para-Digital-Twins/010_Sensorizacion/` |
