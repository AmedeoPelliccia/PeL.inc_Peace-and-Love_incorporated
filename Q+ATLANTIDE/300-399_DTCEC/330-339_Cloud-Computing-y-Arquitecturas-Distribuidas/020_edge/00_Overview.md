---
document_id: QATL-ATLAS-1000-DTCEC-330-339-03-020-00-OVERVIEW
title: "DTCEC 330-339 · 03.020.00 — edge"
register: ATLAS-1000
...
language: en
---
# DTCEC 330-339 · Section 03 · Subsection 020 — edge

## 1. Purpose

Overview entry-point for the *edge* subsection within the `330-339` code range (Section `03` — *Cloud Computing y Arquitecturas Distribuidas*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 330-339.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *edge* slice of the parent code range `330-339`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/330-339_Cloud-Computing-y-Arquitecturas-Distribuidas/020_edge/` |
