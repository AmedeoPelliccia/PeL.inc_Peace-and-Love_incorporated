---
document_id: QATL-ATLAS-1000-DTCEC-390-399-09-20-00-OVERVIEW
title: "DTCEC 390-399 · 09.20.00 — self-updating models"
register: ATLAS-1000
...
language: en
---
# DTCEC 390-399 · Section 09 · Subsection 20 — self-updating models
...
This subsubject (`00 Overview`) introduces the DTCEC 390-399.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — self-updating models |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/390-399_Digital-Twins-Conscientes-y-Evolutivos/20_self-updating-models/` |
