...
Overview of the *KPI* subsection within the `380-389` code range (Section `08` — Analytics y Business Intelligence) of the DTCEC architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *KPI*.

## Scope

- Covers the *KPI* slice of the parent code range.
