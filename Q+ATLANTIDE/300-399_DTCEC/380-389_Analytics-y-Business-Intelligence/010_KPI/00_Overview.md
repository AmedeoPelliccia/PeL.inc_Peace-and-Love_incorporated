---
document_id: QATL-ATLAS-1000-DTCEC-380-389-08-010-00-OVERVIEW
title: "DTCEC 380-389 · 08.010.00 — KPI"
register: ATLAS-1000
...
language: en
---
# DTCEC 380-389 · Section 08 · Subsection 010 — KPI

## 1. Purpose

Overview entry-point for the *KPI* subsection within the `380-389` code range (Section `08` — *Analytics y Business Intelligence*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 380-389.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *KPI* slice of the parent code range `380-389`.
...
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/380-389_Analytics-y-Business-Intelligence/010_KPI/` |
