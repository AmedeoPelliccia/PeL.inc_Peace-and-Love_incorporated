---
document_id: QATL-ATLAS-1000-DTCEC-380-389-08-020-00-OVERVIEW
title: "DTCEC 380-389 · 08.020.00 — EVM analytics"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "EVM analytics"
subsubject: "00"
...
language: en
---
# DTCEC 380-389 · Section 08 · Subsection 020 — EVM analytics

## 1. Purpose

Overview entry-point for the *EVM analytics* subsection within the `380-389` code range (Section `08` — *Analytics y Business Intelligence*) of the **DTCEC** architecture band (*Digital Twin, Cloud, Edge & AI Architecture*, master range `300–399`).

This subsubject (`00 Overview`) introduces the DTCEC 380-389.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *EVM analytics* slice of the parent code range `380-389`.
...
| Subsection | `020` — EVM analytics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/380-389_Analytics-y-Business-Intelligence/020_EVM-analytics/` |
