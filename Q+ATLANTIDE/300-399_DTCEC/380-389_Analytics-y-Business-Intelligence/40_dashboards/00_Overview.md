---
document_id: QATL-ATLAS-1000-DTCEC-380-389-08-40-00-OVERVIEW
title: "DTCEC 380-389 · 08.40.00 — dashboards"
register: ATLAS-1000
...
language: en
---
# DTCEC 380-389 · Section 08 · Subsection 40 — dashboards
...
This subsubject (`00 Overview`) introduces the DTCEC 380-389.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — dashboards |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/300-399_DTCEC/380-389_Analytics-y-Business-Intelligence/40_dashboards/` |
