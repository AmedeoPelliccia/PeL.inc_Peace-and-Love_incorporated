---
document_id: QATL-ATLAS-1000-DTTA-270-279-07-40-00-OVERVIEW
title: "DTTA 270-279 · 07.40.00 — entrenamiento XR"
register: ATLAS-1000
...
language: en
---
# DTTA 270-279 · Section 07 · Subsection 40 — entrenamiento XR
...
This subsubject (`00 Overview`) introduces the DTTA 270-279.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — entrenamiento XR |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-AIR, Q-GROUND |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/270-279_Simulacion-y-Entrenamiento-Militar/40_entrenamiento-XR/` |
