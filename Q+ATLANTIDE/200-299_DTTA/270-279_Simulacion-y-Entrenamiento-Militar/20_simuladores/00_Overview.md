---
document_id: QATL-ATLAS-1000-DTTA-270-279-07-20-00-OVERVIEW
title: "DTTA 270-279 · 07.20.00 — simuladores"
register: ATLAS-1000
...
language: en
---
# DTTA 270-279 · Section 07 · Subsection 20 — simuladores
...
This subsubject (`00 Overview`) introduces the DTTA 270-279.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — simuladores |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-AIR, Q-GROUND |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/270-279_Simulacion-y-Entrenamiento-Militar/20_simuladores/` |
