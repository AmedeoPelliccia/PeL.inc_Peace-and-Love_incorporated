---
document_id: QATL-ATLAS-1000-DTTA-270-279-07-020-00-OVERVIEW
title: "DTTA 270-279 · 07.020.00 — simuladores"
register: ATLAS-1000
...
language: en
---
# DTTA 270-279 · Section 07 · Subsection 020 — simuladores

## 1. Purpose

Overview entry-point for the *simuladores* subsection within the `270-279` code range (Section `07` — *Simulación y Entrenamiento Militar*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 270-279.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *simuladores* slice of the parent code range `270-279`.
...
| Subsection | `020` — simuladores |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-AIR, Q-GROUND |
| ORB support | ORB-PMO, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/270-279_Simulacion-y-Entrenamiento-Militar/020_simuladores/` |
