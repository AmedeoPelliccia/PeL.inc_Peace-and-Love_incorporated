---
document_id: QATL-ATLAS-1000-DTTA-200-209-00-020-00-OVERVIEW
title: "DTTA 200-209 · 00.020.00 — efectos"
register: ATLAS-1000
...
language: en
---
# DTTA 200-209 · Section 00 · Subsection 020 — efectos

## 1. Purpose

Overview entry-point for the *efectos* subsection within the `200-209` code range (Section `00` — *Sistemas de Combate y Armamento*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 200-209.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *efectos* slice of the parent code range `200-209`.
...
| Subsection | `020` — efectos |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-SPACE, Q-DATAGOV |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/200-209_Sistemas-de-Combate-y-Armamento/020_efectos/` |
