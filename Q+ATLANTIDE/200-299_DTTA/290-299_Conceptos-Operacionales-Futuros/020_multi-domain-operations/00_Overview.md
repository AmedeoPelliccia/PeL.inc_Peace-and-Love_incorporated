---
document_id: QATL-ATLAS-1000-DTTA-290-299-09-020-00-OVERVIEW
title: "DTTA 290-299 · 09.020.00 — multi-domain operations"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "multi-domain operations"
subsubject: "00"
...
language: en
---
# DTTA 290-299 · Section 09 · Subsection 020 — multi-domain operations

## 1. Purpose

Overview entry-point for the *multi-domain operations* subsection within the `290-299` code range (Section `09` — *Conceptos Operacionales Futuros*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 290-299.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *multi-domain operations* slice of the parent code range `290-299`.
...
| Subsection | `020` — multi-domain operations |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV, Q-SPACE |
| ORB support | ORB-PMO, ORB-MKTG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/290-299_Conceptos-Operacionales-Futuros/020_multi-domain-operations/` |
