...
Overview of the *UGV* subsection within the `230-239` code range (Section `03` — Robótica y Sistemas Autónomos de Defensa) of the DTTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *UGV*.

## Scope

- Covers the *UGV* slice of the parent code range.
