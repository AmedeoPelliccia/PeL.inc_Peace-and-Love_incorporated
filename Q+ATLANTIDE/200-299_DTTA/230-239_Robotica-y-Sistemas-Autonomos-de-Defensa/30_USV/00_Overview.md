...
Overview of the *USV* subsection within the `230-239` code range (Section `03` — Robótica y Sistemas Autónomos de Defensa) of the DTTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *USV*.

## Scope

- Covers the *USV* slice of the parent code range.
