---
document_id: QATL-ATLAS-1000-DTTA-230-239-03-010-00-OVERVIEW
title: "DTTA 230-239 · 03.010.00 — UGV"
register: ATLAS-1000
...
language: en
---
# DTTA 230-239 · Section 03 · Subsection 010 — UGV

## 1. Purpose

Overview entry-point for the *UGV* subsection within the `230-239` code range (Section `03` — *Robótica y Sistemas Autónomos de Defensa*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 230-239.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *UGV* slice of the parent code range `230-239`.
...
| Folder path | `Q+ATLANTIDE/200-299_DTTA/230-239_Robotica-y-Sistemas-Autonomos-de-Defensa/010_UGV/` |
