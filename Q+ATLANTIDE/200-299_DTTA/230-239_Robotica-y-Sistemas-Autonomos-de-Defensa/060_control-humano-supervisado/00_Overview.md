---
document_id: QATL-ATLAS-1000-DTTA-230-239-03-060-00-OVERVIEW
title: "DTTA 230-239 · 03.060.00 — control humano-supervisado"
register: ATLAS-1000
...
subsection: "060"
subsection_title: "control humano-supervisado"
subsubject: "00"
...
language: en
---
# DTTA 230-239 · Section 03 · Subsection 060 — control humano-supervisado

## 1. Purpose

Overview entry-point for the *control humano-supervisado* subsection within the `230-239` code range (Section `03` — *Robótica y Sistemas Autónomos de Defensa*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 230-239.060.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *control humano-supervisado* slice of the parent code range `230-239`.
...
| Subsection | `060` — control humano-supervisado |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-HORIZON, Q-DATAGOV, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/230-239_Robotica-y-Sistemas-Autonomos-de-Defensa/060_control-humano-supervisado/` |
