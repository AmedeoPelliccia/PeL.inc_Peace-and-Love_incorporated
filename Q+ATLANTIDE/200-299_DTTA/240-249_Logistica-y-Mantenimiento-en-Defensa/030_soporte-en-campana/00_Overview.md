---
document_id: QATL-ATLAS-1000-DTTA-240-249-04-030-00-OVERVIEW
title: "DTTA 240-249 · 04.030.00 — soporte en campaña"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "soporte en campaña"
subsubject: "00"
...
language: en
---
# DTTA 240-249 · Section 04 · Subsection 030 — soporte en campaña

## 1. Purpose

Overview entry-point for the *soporte en campaña* subsection within the `240-249` code range (Section `04` — *Logística y Mantenimiento en Defensa*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 240-249.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *soporte en campaña* slice of the parent code range `240-249`.
...
| Subsection | `030` — soporte en campaña |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-DATAGOV, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/240-249_Logistica-y-Mantenimiento-en-Defensa/030_soporte-en-campana/` |
