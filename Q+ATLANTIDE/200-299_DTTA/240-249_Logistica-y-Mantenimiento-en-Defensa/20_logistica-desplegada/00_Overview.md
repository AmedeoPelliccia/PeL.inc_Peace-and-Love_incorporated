---
document_id: QATL-ATLAS-1000-DTTA-240-249-04-20-00-OVERVIEW
title: "DTTA 240-249 · 04.20.00 — logística desplegada"
register: ATLAS-1000
...
language: en
---
# DTTA 240-249 · Section 04 · Subsection 20 — logística desplegada
...
This subsubject (`00 Overview`) introduces the DTTA 240-249.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — logística desplegada |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-DATAGOV, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/240-249_Logistica-y-Mantenimiento-en-Defensa/20_logistica-desplegada/` |
