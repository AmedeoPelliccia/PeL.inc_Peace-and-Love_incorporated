---
document_id: QATL-ATLAS-1000-DTTA-280-289-08-020-00-OVERVIEW
title: "DTTA 280-289 · 08.020.00 — quantum comms"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "quantum comms"
subsubject: "00"
...
language: en
---
# DTTA 280-289 · Section 08 · Subsection 020 — quantum comms

## 1. Purpose

Overview entry-point for the *quantum comms* subsection within the `280-289` code range (Section `08` — *Guerra Cuántica y Tecnologías Disruptivas*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 280-289.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *quantum comms* slice of the parent code range `280-289`.
...
| Subsection | `020` — quantum comms |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV, Q-SPACE |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/280-289_Guerra-Cuantica-y-Tecnologias-Disruptivas/020_quantum-comms/` |
