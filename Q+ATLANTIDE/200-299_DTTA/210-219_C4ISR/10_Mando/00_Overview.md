...
Overview of the *Mando* subsection within the `210-219` code range (Section `01` — C4ISR) of the DTTA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Mando*.

## Scope

- Covers the *Mando* slice of the parent code range.
