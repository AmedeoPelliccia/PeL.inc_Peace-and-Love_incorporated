---
document_id: QATL-ATLAS-1000-DTTA-210-219-01-060-00-OVERVIEW
title: "DTTA 210-219 · 01.060.00 — reconocimiento"
register: ATLAS-1000
...
subsection: "060"
subsection_title: "reconocimiento"
subsubject: "00"
...
language: en
---
# DTTA 210-219 · Section 01 · Subsection 060 — reconocimiento

## 1. Purpose

Overview entry-point for the *reconocimiento* subsection within the `210-219` code range (Section `01` — *C4ISR*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 210-219.060.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *reconocimiento* slice of the parent code range `210-219`.
...
| Subsection | `060` — reconocimiento |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/210-219_C4ISR/060_reconocimiento/` |
