---
document_id: QATL-ATLAS-1000-DTTA-210-219-01-040-00-OVERVIEW
title: "DTTA 210-219 · 01.040.00 — inteligencia"
register: ATLAS-1000
...
language: en
---
# DTTA 210-219 · Section 01 · Subsection 040 — inteligencia

## 1. Purpose

Overview entry-point for the *inteligencia* subsection within the `210-219` code range (Section `01` — *C4ISR*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 210-219.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *inteligencia* slice of the parent code range `210-219`.
...
| Subsection | `040` — inteligencia |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/210-219_C4ISR/040_inteligencia/` |
