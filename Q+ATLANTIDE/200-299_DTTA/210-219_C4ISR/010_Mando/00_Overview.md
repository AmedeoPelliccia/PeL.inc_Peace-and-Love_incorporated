---
document_id: QATL-ATLAS-1000-DTTA-210-219-01-010-00-OVERVIEW
title: "DTTA 210-219 · 01.010.00 — Mando"
register: ATLAS-1000
...
language: en
---
# DTTA 210-219 · Section 01 · Subsection 010 — Mando

## 1. Purpose

Overview entry-point for the *Mando* subsection within the `210-219` code range (Section `01` — *C4ISR*) of the **DTTA** architecture band (*Defence Technology Type Architecture*, master range `200–299`).

This subsubject (`00 Overview`) introduces the DTTA 210-219.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Mando* slice of the parent code range `210-219`.
...
| Subsection | `010` — Mando |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/200-299_DTTA/210-219_C4ISR/010_Mando/` |
