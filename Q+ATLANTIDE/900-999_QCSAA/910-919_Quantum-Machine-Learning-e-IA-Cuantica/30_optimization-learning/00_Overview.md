---
document_id: QATL-ATLAS-1000-QCSAA-910-919-01-30-00-OVERVIEW
title: "QCSAA 910-919 · 01.30.00 — optimization learning"
register: ATLAS-1000
...
language: en
---
# QCSAA 910-919 · Section 01 · Subsection 30 — optimization learning
...
This subsubject (`00 Overview`) introduces the QCSAA 910-919.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — optimization learning |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-HORIZON, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/900-999_QCSAA/910-919_Quantum-Machine-Learning-e-IA-Cuantica/30_optimization-learning/` |
