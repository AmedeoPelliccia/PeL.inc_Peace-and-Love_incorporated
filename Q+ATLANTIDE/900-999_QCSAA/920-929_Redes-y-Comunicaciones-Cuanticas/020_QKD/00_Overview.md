---
document_id: QATL-ATLAS-1000-QCSAA-920-929-02-020-00-OVERVIEW
title: "QCSAA 920-929 · 02.020.00 — QKD"
register: ATLAS-1000
...
language: en
---
# QCSAA 920-929 · Section 02 · Subsection 020 — QKD

## 1. Purpose

Overview entry-point for the *QKD* subsection within the `920-929` code range (Section `02` — *Redes y Comunicaciones Cuánticas*) of the **QCSAA** architecture band (*Quantum Computing & Sentient Agency Architecture*, master range `900–999`).

This subsubject (`00 Overview`) introduces the QCSAA 920-929.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *QKD* slice of the parent code range `920-929`.
...
| Folder path | `Q+ATLANTIDE/900-999_QCSAA/920-929_Redes-y-Comunicaciones-Cuanticas/020_QKD/` |
