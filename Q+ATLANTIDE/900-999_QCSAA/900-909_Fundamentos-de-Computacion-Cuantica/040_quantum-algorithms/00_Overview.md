---
document_id: QATL-ATLAS-1000-QCSAA-900-909-00-040-00-OVERVIEW
title: "QCSAA 900-909 · 00.040.00 — quantum algorithms"
register: ATLAS-1000
...
language: en
---
# QCSAA 900-909 · Section 00 · Subsection 040 — quantum algorithms
...
| Subsection | `040` — quantum algorithms |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-DATAGOV |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/900-999_QCSAA/900-909_Fundamentos-de-Computacion-Cuantica/040_quantum-algorithms/` |
