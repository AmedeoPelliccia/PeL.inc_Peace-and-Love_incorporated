...
Overview of the *Q-sensing* subsection within the `080-089` code range (Section `08` — Propulsión Alternativa & Cuántica) of the ATLAS architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Q-sensing*.

## Scope

- Covers the *Q-sensing* slice of the parent code range.
