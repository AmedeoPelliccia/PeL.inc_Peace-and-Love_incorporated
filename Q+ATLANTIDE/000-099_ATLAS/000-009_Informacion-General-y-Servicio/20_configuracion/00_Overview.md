---
document_id: QATL-ATLAS-1000-ATLAS-000-009-00-20-00-OVERVIEW
title: "ATLAS 000-009 · 00.20.00 — configuración"
register: ATLAS-1000
...
language: en
---
# ATLAS 000-009 · Section 00 · Subsection 20 — configuración
...
This subsubject (`00 Overview`) introduces the ATLAS 000-009.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — configuración |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-GROUND, Q-AIR |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/000-099_ATLAS/000-009_Informacion-General-y-Servicio/20_configuracion/` |
