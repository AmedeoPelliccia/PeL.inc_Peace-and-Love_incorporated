...
Overview of the *Turbofan* subsection within the `060-069` code range (Section `06` — Propulsión Tradicional) of the ATLAS architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Turbofan*.

## Scope

- Covers the *Turbofan* slice of the parent code range.
