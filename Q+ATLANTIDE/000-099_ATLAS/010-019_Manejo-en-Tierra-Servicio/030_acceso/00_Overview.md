...
This subsubject (`00 Overview`) introduces the ATLAS 010-019.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
