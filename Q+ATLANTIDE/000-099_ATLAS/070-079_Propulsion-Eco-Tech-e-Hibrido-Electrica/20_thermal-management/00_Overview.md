...
Overview of the *thermal management* subsection within the `070-079` code range (Section `07` — Propulsión Eco-Tech e Híbrido-Eléctrica) of the ATLAS architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *thermal management*.

## Scope

- Covers the *thermal management* slice of the parent code range.
