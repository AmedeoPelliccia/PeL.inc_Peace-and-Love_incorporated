---
document_id: QATL-ATLAS-1000-STA-120-129-02-030-00-OVERVIEW
title: "STA 120-129 · 02.030.00 — nuclear conceptual"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "nuclear conceptual"
subsubject: "00"
...
language: en
---
# STA 120-129 · Section 02 · Subsection 030 — nuclear conceptual

## 1. Purpose

Overview entry-point for the *nuclear conceptual* subsection within the `120-129` code range (Section `02` — *Propulsión Espacial Tradicional y Avanzada*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 120-129.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *nuclear conceptual* slice of the parent code range `120-129`.
...
| Subsection | `030` — nuclear conceptual |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HORIZON, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/120-129_Propulsion-Espacial-Tradicional-y-Avanzada/030_nuclear-conceptual/` |
...
[^archtable]: **STA §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `120-129` row (Section `02` — Propulsión Espacial Tradicional y Avanzada, Primary Q-Division Q-GREENTECH).
