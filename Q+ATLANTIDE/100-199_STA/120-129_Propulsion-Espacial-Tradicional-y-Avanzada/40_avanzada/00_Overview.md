...
Overview of the *avanzada* subsection within the `120-129` code range (Section `02` — Propulsión Espacial Tradicional y Avanzada) of the STA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *avanzada*.

## Scope

- Covers the *avanzada* slice of the parent code range.
