---
document_id: QATL-ATLAS-1000-STA-120-129-02-020-00-OVERVIEW
title: "STA 120-129 · 02.020.00 — eléctrica"
register: ATLAS-1000
...
language: en
---
# STA 120-129 · Section 02 · Subsection 020 — eléctrica

## 1. Purpose

Overview entry-point for the *eléctrica* subsection within the `120-129` code range (Section `02` — *Propulsión Espacial Tradicional y Avanzada*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 120-129.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *eléctrica* slice of the parent code range `120-129`.
...
| Subsection | `020` — eléctrica |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HORIZON, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/120-129_Propulsion-Espacial-Tradicional-y-Avanzada/020_electrica/` |
