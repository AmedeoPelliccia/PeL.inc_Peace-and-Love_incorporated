---
document_id: QATL-ATLAS-1000-STA-190-199-09-020-00-OVERVIEW
title: "STA 190-199 · 09.020.00 — hábitats avanzados"
register: ATLAS-1000
...
language: en
---
# STA 190-199 · Section 09 · Subsection 020 — hábitats avanzados

## 1. Purpose

Overview entry-point for the *hábitats avanzados* subsection within the `190-199` code range (Section `09` — *Sistemas Avanzados, Conceptos y Futuro Espacial*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 190-199.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *hábitats avanzados* slice of the parent code range `190-199`.
...
| Subsection | `020` — hábitats avanzados |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC, Q-GREENTECH |
| ORB support | ORB-PMO, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/190-199_Sistemas-Avanzados-Conceptos-y-Futuro-Espacial/020_habitats-avanzados/` |
