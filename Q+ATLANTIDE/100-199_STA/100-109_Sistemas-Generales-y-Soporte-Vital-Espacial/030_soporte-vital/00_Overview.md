---
document_id: QATL-ATLAS-1000-STA-100-109-00-030-00-OVERVIEW
title: "STA 100-109 · 00.030.00 — soporte vital"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "soporte vital"
subsubject: "00"
...
language: en
---
# STA 100-109 · Section 00 · Subsection 030 — soporte vital

## 1. Purpose

Overview entry-point for the *soporte vital* subsection within the `100-109` code range (Section `00` — *Sistemas Generales y Soporte Vital Espacial*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 100-109.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *soporte vital* slice of the parent code range `100-109`.
...
| Subsection | `030` — soporte vital |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HORIZON |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/100-109_Sistemas-Generales-y-Soporte-Vital-Espacial/030_soporte-vital/` |
