---
document_id: QATL-ATLAS-1000-STA-140-149-04-020-00-OVERVIEW
title: "STA 140-149 · 04.020.00 — avionics"
register: ATLAS-1000
...
language: en
---
# STA 140-149 · Section 04 · Subsection 020 — avionics

## 1. Purpose

Overview entry-point for the *avionics* subsection within the `140-149` code range (Section `04` — *Aviónica y Control de Misión Espacial*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 140-149.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *avionics* slice of the parent code range `140-149`.
...
| Subsection | `020` — avionics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC, Q-HORIZON |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/140-149_Avionica-y-Control-de-Mision-Espacial/020_avionics/` |
