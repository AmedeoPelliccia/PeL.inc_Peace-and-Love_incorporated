...
Overview of the *GNC* subsection within the `140-149` code range (Section `04` — Aviónica y Control de Misión Espacial) of the STA architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *GNC*.

## Scope

- Covers the *GNC* slice of the parent code range.
