---
document_id: QATL-ATLAS-1000-STA-170-179-07-30-00-OVERVIEW
title: "STA 170-179 · 07.30.00 — reparación"
register: ATLAS-1000
...
language: en
---
# STA 170-179 · Section 07 · Subsection 30 — reparación
...
This subsubject (`00 Overview`) introduces the STA 170-179.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — reparación |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-GROUND, Q-HORIZON, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/170-179_Operaciones-y-Mantenimiento-en-Orbita/30_reparacion/` |
