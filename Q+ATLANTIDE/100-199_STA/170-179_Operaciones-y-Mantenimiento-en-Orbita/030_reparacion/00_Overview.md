---
document_id: QATL-ATLAS-1000-STA-170-179-07-030-00-OVERVIEW
title: "STA 170-179 · 07.030.00 — reparación"
register: ATLAS-1000
...
language: en
---
# STA 170-179 · Section 07 · Subsection 030 — reparación

## 1. Purpose

Overview entry-point for the *reparación* subsection within the `170-179` code range (Section `07` — *Operaciones y Mantenimiento en Órbita*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 170-179.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *reparación* slice of the parent code range `170-179`.
...
| Subsection | `030` — reparación |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-GROUND, Q-HORIZON, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/170-179_Operaciones-y-Mantenimiento-en-Orbita/030_reparacion/` |
