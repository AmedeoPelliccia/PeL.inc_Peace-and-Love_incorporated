---
document_id: QATL-ATLAS-1000-STA-170-179-07-20-00-OVERVIEW
title: "STA 170-179 · 07.20.00 — inspección"
register: ATLAS-1000
...
language: en
---
# STA 170-179 · Section 07 · Subsection 20 — inspección
...
This subsubject (`00 Overview`) introduces the STA 170-179.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — inspección |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-GROUND, Q-HORIZON, Q-MECHANICS |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/170-179_Operaciones-y-Mantenimiento-en-Orbita/20_inspeccion/` |
