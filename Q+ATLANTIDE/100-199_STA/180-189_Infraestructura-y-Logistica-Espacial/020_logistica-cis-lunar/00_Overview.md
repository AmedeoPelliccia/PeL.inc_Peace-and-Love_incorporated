---
document_id: QATL-ATLAS-1000-STA-180-189-08-020-00-OVERVIEW
title: "STA 180-189 · 08.020.00 — logística cis-lunar"
register: ATLAS-1000
...
language: en
---
# STA 180-189 · Section 08 · Subsection 020 — logística cis-lunar

## 1. Purpose

Overview entry-point for the *logística cis-lunar* subsection within the `180-189` code range (Section `08` — *Infraestructura y Logística Espacial*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 180-189.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *logística cis-lunar* slice of the parent code range `180-189`.
...
| Subsection | `020` — logística cis-lunar |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-GROUND, Q-HORIZON |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/180-189_Infraestructura-y-Logistica-Espacial/020_logistica-cis-lunar/` |
