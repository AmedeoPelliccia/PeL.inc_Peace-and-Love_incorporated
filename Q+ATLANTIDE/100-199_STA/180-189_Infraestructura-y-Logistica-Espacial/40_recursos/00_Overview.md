---
document_id: QATL-ATLAS-1000-STA-180-189-08-40-00-OVERVIEW
title: "STA 180-189 · 08.40.00 — recursos"
register: ATLAS-1000
...
language: en
---
# STA 180-189 · Section 08 · Subsection 40 — recursos
...
This subsubject (`00 Overview`) introduces the STA 180-189.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — recursos |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-GROUND, Q-HORIZON |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/180-189_Infraestructura-y-Logistica-Espacial/40_recursos/` |
