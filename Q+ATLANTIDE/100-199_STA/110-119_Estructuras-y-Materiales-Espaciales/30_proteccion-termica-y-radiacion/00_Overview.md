---
document_id: QATL-ATLAS-1000-STA-110-119-01-30-00-OVERVIEW
title: "STA 110-119 · 01.30.00 — protección térmica y radiación"
register: ATLAS-1000
...
language: en
---
# STA 110-119 · Section 01 · Subsection 30 — protección térmica y radiación
...
This subsubject (`00 Overview`) introduces the STA 110-119.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — protección térmica y radiación |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-STRUCTURES[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HORIZON, Q-INDUSTRY |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/110-119_Estructuras-y-Materiales-Espaciales/30_proteccion-termica-y-radiacion/` |
