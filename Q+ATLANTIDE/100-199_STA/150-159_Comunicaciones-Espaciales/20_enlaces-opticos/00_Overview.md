---
document_id: QATL-ATLAS-1000-STA-150-159-05-20-00-OVERVIEW
title: "STA 150-159 · 05.20.00 — enlaces ópticos"
register: ATLAS-1000
...
language: en
---
# STA 150-159 · Section 05 · Subsection 20 — enlaces ópticos
...
This subsubject (`00 Overview`) introduces the STA 150-159.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — enlaces ópticos |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/150-159_Comunicaciones-Espaciales/20_enlaces-opticos/` |
