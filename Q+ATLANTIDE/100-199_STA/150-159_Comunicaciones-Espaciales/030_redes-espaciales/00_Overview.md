---
document_id: QATL-ATLAS-1000-STA-150-159-05-030-00-OVERVIEW
title: "STA 150-159 · 05.030.00 — redes espaciales"
register: ATLAS-1000
...
language: en
---
# STA 150-159 · Section 05 · Subsection 030 — redes espaciales

## 1. Purpose

Overview entry-point for the *redes espaciales* subsection within the `150-159` code range (Section `05` — *Comunicaciones Espaciales*) of the **STA** architecture band (*Space Technology Architecture*, master range `100–199`).

This subsubject (`00 Overview`) introduces the STA 150-159.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *redes espaciales* slice of the parent code range `150-159`.
...
| Subsection | `030` — redes espaciales |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-SPACE[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/100-199_STA/150-159_Comunicaciones-Espaciales/030_redes-espaciales/` |
