---
document_id: QATL-ATLAS-1000-ACV-710-719-01-010-00-OVERVIEW
title: "ACV 710-719 · 01.010.00 — Vertiports"
register: ATLAS-1000
...
language: en
---
# ACV 710-719 · Section 01 · Subsection 010 — Vertiports

## 1. Purpose

Overview entry-point for the *Vertiports* subsection within the `710-719` code range (Section `01` — *Vertipuertos y Heliplataformas*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 710-719.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Vertiports* slice of the parent code range `710-719`.
...
| Subsection | `010` — Vertiports |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/710-719_Vertipuertos-y-Heliplataformas/010_Vertiports/` |
