---
document_id: QATL-ATLAS-1000-ACV-710-719-01-20-00-OVERVIEW
title: "ACV 710-719 · 01.20.00 — charging/refuelling"
register: ATLAS-1000
...
language: en
---
# ACV 710-719 · Section 01 · Subsection 20 — charging/refuelling
...
This subsubject (`00 Overview`) introduces the ACV 710-719.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — charging/refuelling |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/710-719_Vertipuertos-y-Heliplataformas/20_charging-refuelling/` |
