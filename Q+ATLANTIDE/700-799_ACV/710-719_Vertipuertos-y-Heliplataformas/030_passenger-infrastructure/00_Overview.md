---
document_id: QATL-ATLAS-1000-ACV-710-719-01-030-00-OVERVIEW
title: "ACV 710-719 · 01.030.00 — passenger infrastructure"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "passenger infrastructure"
subsubject: "00"
...
language: en
---
# ACV 710-719 · Section 01 · Subsection 030 — passenger infrastructure

## 1. Purpose

Overview entry-point for the *passenger infrastructure* subsection within the `710-719` code range (Section `01` — *Vertipuertos y Heliplataformas*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 710-719.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *passenger infrastructure* slice of the parent code range `710-719`.
...
| Subsection | `030` — passenger infrastructure |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-INDUSTRY |
| ORB support | ORB-FIN, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/710-719_Vertipuertos-y-Heliplataformas/030_passenger-infrastructure/` |
