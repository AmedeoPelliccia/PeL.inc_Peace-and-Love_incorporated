...
Overview of the *Vertiports* subsection within the `710-719` code range (Section `01` — Vertipuertos y Heliplataformas) of the ACV architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Vertiports*.

## Scope

- Covers the *Vertiports* slice of the parent code range.
