---
document_id: QATL-ATLAS-1000-ACV-700-709-00-010-00-OVERVIEW
title: "ACV 700-709 · 00.010.00 — eVTOL"
register: ATLAS-1000
...
language: en
---
# ACV 700-709 · Section 00 · Subsection 010 — eVTOL

## 1. Purpose

Overview entry-point for the *eVTOL* subsection within the `700-709` code range (Section `00` — *Vehículos de Movilidad Aérea Urbana*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 700-709.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *eVTOL* slice of the parent code range `700-709`.
