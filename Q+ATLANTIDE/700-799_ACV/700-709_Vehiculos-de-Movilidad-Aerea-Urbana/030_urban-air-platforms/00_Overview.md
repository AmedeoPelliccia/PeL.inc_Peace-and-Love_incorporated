---
document_id: QATL-ATLAS-1000-ACV-700-709-00-030-00-OVERVIEW
title: "ACV 700-709 · 00.030.00 — urban air platforms"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "urban air platforms"
subsubject: "00"
...
language: en
---
# ACV 700-709 · Section 00 · Subsection 030 — urban air platforms

## 1. Purpose

Overview entry-point for the *urban air platforms* subsection within the `700-709` code range (Section `00` — *Vehículos de Movilidad Aérea Urbana*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 700-709.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *urban air platforms* slice of the parent code range `700-709`.
...
| Subsection | `030` — urban air platforms |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-AIR[^qdiv] |
| Support Q-Divisions | Q-GREENTECH, Q-STRUCTURES, Q-HPC |
| ORB support | ORB-MKTG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/700-709_Vehiculos-de-Movilidad-Aerea-Urbana/030_urban-air-platforms/` |
...
[^archtable]: **ACV §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `700-709` row (Section `00` — Vehículos de Movilidad Aérea Urbana, Primary Q-Division Q-AIR).
