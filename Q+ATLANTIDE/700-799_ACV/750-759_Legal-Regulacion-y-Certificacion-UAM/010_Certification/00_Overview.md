---
document_id: QATL-ATLAS-1000-ACV-750-759-05-010-00-OVERVIEW
title: "ACV 750-759 · 05.010.00 — Certification"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Certification"
subsubject: "00"
...
language: en
---
# ACV 750-759 · Section 05 · Subsection 010 — Certification

## 1. Purpose

Overview entry-point for the *Certification* subsection within the `750-759` code range (Section `05` — *Legal, Regulación y Certificación UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 750-759.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Certification* slice of the parent code range `750-759`.
...
| Subsection | `010` — Certification |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-GROUND |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/750-759_Legal-Regulacion-y-Certificacion-UAM/010_Certification/` |
