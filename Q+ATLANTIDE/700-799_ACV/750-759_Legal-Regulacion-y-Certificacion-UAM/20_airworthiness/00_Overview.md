...
Overview of the *airworthiness* subsection within the `750-759` code range (Section `05` — Legal, Regulación y Certificación UAM) of the ACV architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *airworthiness*.

## Scope

- Covers the *airworthiness* slice of the parent code range.
