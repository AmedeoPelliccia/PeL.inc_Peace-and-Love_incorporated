---
document_id: QATL-ATLAS-1000-ACV-760-769-06-20-00-OVERVIEW
title: "ACV 760-769 · 06.20.00 — accessibility"
register: ATLAS-1000
...
language: en
---
# ACV 760-769 · Section 06 · Subsection 20 — accessibility
...
This subsubject (`00 Overview`) introduces the ACV 760-769.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — accessibility |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-DATAGOV |
| ORB support | ORB-MKTG, ORB-CSR |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/760-769_Interfaz-Urbana-y-Aceptacion-Social/20_accessibility/` |
