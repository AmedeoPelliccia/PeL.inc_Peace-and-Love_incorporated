---
document_id: QATL-ATLAS-1000-ACV-760-769-06-010-00-OVERVIEW
title: "ACV 760-769 · 06.010.00 — Human factors"
register: ATLAS-1000
...
language: en
---
# ACV 760-769 · Section 06 · Subsection 010 — Human factors

## 1. Purpose

Overview entry-point for the *Human factors* subsection within the `760-769` code range (Section `06` — *Interfaz Urbana y Aceptación Social*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 760-769.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Human factors* slice of the parent code range `760-769`.
...
| Subsection | `010` — Human factors |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GROUND[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-DATAGOV |
| ORB support | ORB-MKTG, ORB-CSR |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/760-769_Interfaz-Urbana-y-Aceptacion-Social/010_Human-factors/` |
