---
document_id: QATL-ATLAS-1000-ACV-790-799-09-020-00-OVERVIEW
title: "ACV 790-799 · 09.020.00 — business models"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "business models"
subsubject: "00"
...
language: en
---
# ACV 790-799 · Section 09 · Subsection 020 — business models

## 1. Purpose

Overview entry-point for the *business models* subsection within the `790-799` code range (Section `09` — *Modelos de Negocio y Ecosistemas UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 790-799.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *business models* slice of the parent code range `790-799`.
...
| Subsection | `020` — business models |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-GROUND |
| ORB support | ORB-MKTG, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/790-799_Modelos-de-Negocio-y-Ecosistemas-UAM/020_business-models/` |
