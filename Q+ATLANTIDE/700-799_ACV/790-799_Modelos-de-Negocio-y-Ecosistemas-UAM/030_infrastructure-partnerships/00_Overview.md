---
document_id: QATL-ATLAS-1000-ACV-790-799-09-030-00-OVERVIEW
title: "ACV 790-799 · 09.030.00 — infrastructure partnerships"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "infrastructure partnerships"
subsubject: "00"
...
language: en
---
# ACV 790-799 · Section 09 · Subsection 030 — infrastructure partnerships

## 1. Purpose

Overview entry-point for the *infrastructure partnerships* subsection within the `790-799` code range (Section `09` — *Modelos de Negocio y Ecosistemas UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 790-799.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *infrastructure partnerships* slice of the parent code range `790-799`.
...
| Subsection | `030` — infrastructure partnerships |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-GROUND |
| ORB support | ORB-MKTG, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/790-799_Modelos-de-Negocio-y-Ecosistemas-UAM/030_infrastructure-partnerships/` |
...
[^archtable]: **ACV §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `790-799` row (Section `09` — Modelos de Negocio y Ecosistemas UAM, Primary Q-Division Q-HORIZON).
