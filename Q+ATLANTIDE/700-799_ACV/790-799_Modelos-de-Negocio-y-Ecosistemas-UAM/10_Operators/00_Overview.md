---
document_id: QATL-ATLAS-1000-ACV-790-799-09-10-00-OVERVIEW
title: "ACV 790-799 · 09.10.00 — Operators"
register: ATLAS-1000
...
language: en
---
# ACV 790-799 · Section 09 · Subsection 10 — Operators

## 1. Purpose

Overview entry-point for the *Operators* subsection within the `790-799` code range (Section `09` — *Modelos de Negocio y Ecosistemas UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 790-799.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Operators* slice of the parent code range `790-799`.
...
| Subsection | `10` — Operators |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HORIZON[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-GROUND |
| ORB support | ORB-MKTG, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/790-799_Modelos-de-Negocio-y-Ecosistemas-UAM/10_Operators/` |
