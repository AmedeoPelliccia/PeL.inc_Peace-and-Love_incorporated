---
document_id: QATL-ATLAS-1000-ACV-740-749-04-040-00-OVERVIEW
title: "ACV 740-749 · 04.040.00 — urban sustainability"
register: ATLAS-1000
...
subsection: "040"
subsection_title: "urban sustainability"
subsubject: "00"
...
language: en
---
# ACV 740-749 · Section 04 · Subsection 040 — urban sustainability

## 1. Purpose

Overview entry-point for the *urban sustainability* subsection within the `740-749` code range (Section `04` — *Sostenibilidad Ambiental en UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 740-749.040.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *urban sustainability* slice of the parent code range `740-749`.
...
| Subsection | `040` — urban sustainability |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-GREENTECH[^qdiv] |
| Support Q-Divisions | Q-DATAGOV, Q-HPC |
| ORB support | ORB-CSR, ORB-PMO |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/740-749_Sostenibilidad-Ambiental-en-UAM/040_urban-sustainability/` |
...
[^archtable]: **ACV §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `740-749` row (Section `04` — Sostenibilidad Ambiental en UAM, Primary Q-Division Q-GREENTECH).
