...
Overview of the *Emissions* subsection within the `740-749` code range (Section `04` — Sostenibilidad Ambiental en UAM) of the ACV architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *Emissions*.

## Scope

- Covers the *Emissions* slice of the parent code range.
