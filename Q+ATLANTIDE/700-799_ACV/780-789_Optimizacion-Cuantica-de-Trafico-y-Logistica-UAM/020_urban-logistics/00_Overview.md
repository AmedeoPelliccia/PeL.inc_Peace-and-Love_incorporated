---
document_id: QATL-ATLAS-1000-ACV-780-789-08-020-00-OVERVIEW
title: "ACV 780-789 · 08.020.00 — urban logistics"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "urban logistics"
subsubject: "00"
...
language: en
---
# ACV 780-789 · Section 08 · Subsection 020 — urban logistics

## 1. Purpose

Overview entry-point for the *urban logistics* subsection within the `780-789` code range (Section `08` — *Optimización Cuántica de Tráfico y Logística UAM*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 780-789.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *urban logistics* slice of the parent code range `780-789`.
...
| Subsection | `020` — urban logistics |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-HPC[^qdiv] |
| Support Q-Divisions | Q-AIR, Q-DATAGOV, Q-HORIZON |
| ORB support | ORB-PMO, ORB-FIN |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/780-789_Optimizacion-Cuantica-de-Trafico-y-Logistica-UAM/020_urban-logistics/` |
