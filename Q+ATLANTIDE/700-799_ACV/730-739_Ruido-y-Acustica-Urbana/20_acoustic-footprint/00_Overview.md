---
document_id: QATL-ATLAS-1000-ACV-730-739-03-20-00-OVERVIEW
title: "ACV 730-739 · 03.20.00 — acoustic footprint"
register: ATLAS-1000
...
language: en
---
# ACV 730-739 · Section 03 · Subsection 20 — acoustic footprint
...
This subsubject (`00 Overview`) introduces the ACV 730-739.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — acoustic footprint |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-AIR[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GREENTECH |
| ORB support | ORB-CSR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/730-739_Ruido-y-Acustica-Urbana/20_acoustic-footprint/` |
