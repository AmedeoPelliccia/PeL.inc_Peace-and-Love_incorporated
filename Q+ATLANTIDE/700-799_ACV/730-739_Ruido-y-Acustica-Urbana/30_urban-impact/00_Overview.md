...
Overview of the *urban impact* subsection within the `730-739` code range (Section `03` — Ruido y Acústica Urbana) of the ACV architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *urban impact*.

## Scope

- Covers the *urban impact* slice of the parent code range.
