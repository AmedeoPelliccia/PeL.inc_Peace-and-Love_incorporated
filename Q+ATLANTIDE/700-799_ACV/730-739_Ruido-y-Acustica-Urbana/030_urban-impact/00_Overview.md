---
document_id: QATL-ATLAS-1000-ACV-730-739-03-030-00-OVERVIEW
title: "ACV 730-739 · 03.030.00 — urban impact"
register: ATLAS-1000
...
language: en
---
# ACV 730-739 · Section 03 · Subsection 030 — urban impact

## 1. Purpose

Overview entry-point for the *urban impact* subsection within the `730-739` code range (Section `03` — *Ruido y Acústica Urbana*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 730-739.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *urban impact* slice of the parent code range `730-739`.
...
| Subsection | `030` — urban impact |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-AIR[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GREENTECH |
| ORB support | ORB-CSR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/730-739_Ruido-y-Acustica-Urbana/030_urban-impact/` |
