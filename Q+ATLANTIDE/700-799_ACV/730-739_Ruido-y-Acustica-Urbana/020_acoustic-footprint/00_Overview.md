---
document_id: QATL-ATLAS-1000-ACV-730-739-03-020-00-OVERVIEW
title: "ACV 730-739 · 03.020.00 — acoustic footprint"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "acoustic footprint"
subsubject: "00"
...
language: en
---
# ACV 730-739 · Section 03 · Subsection 020 — acoustic footprint

## 1. Purpose

Overview entry-point for the *acoustic footprint* subsection within the `730-739` code range (Section `03` — *Ruido y Acústica Urbana*) of the **ACV** architecture band (*Aerial City Viability / UAM Architecture*, master range `700–799`).

This subsubject (`00 Overview`) introduces the ACV 730-739.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *acoustic footprint* slice of the parent code range `730-739`.
...
| Subsection | `020` — acoustic footprint |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-AIR[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GREENTECH |
| ORB support | ORB-CSR, ORB-MKTG |
| Governance class | `baseline`[^gov] |
| Folder path | `Q+ATLANTIDE/700-799_ACV/730-739_Ruido-y-Acustica-Urbana/020_acoustic-footprint/` |
...
[^archtable]: **ACV §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `730-739` row (Section `03` — Ruido y Acústica Urbana, Primary Q-Division Q-AIR).
