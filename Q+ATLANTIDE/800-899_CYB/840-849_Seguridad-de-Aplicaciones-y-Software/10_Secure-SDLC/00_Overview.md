---
document_id: QATL-ATLAS-1000-CYB-840-849-04-10-00-OVERVIEW
title: "CYB 840-849 · 04.10.00 — Secure SDLC"
register: ATLAS-1000
...
language: en
---
# CYB 840-849 · Section 04 · Subsection 10 — Secure SDLC
...
This subsubject (`00 Overview`) introduces the CYB 840-849.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `10` — Secure SDLC |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/840-849_Seguridad-de-Aplicaciones-y-Software/10_Secure-SDLC/` |
