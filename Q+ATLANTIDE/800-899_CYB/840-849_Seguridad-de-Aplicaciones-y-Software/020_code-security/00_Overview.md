---
document_id: QATL-ATLAS-1000-CYB-840-849-04-020-00-OVERVIEW
title: "CYB 840-849 · 04.020.00 — code security"
register: ATLAS-1000
...
subsection: "020"
subsection_title: "code security"
subsubject: "00"
...
language: en
---
# CYB 840-849 · Section 04 · Subsection 020 — code security

## 1. Purpose

Overview entry-point for the *code security* subsection within the `840-849` code range (Section `04` — *Seguridad de Aplicaciones y Software*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 840-849.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *code security* slice of the parent code range `840-849`.
...
| Subsection | `020` — code security |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/840-849_Seguridad-de-Aplicaciones-y-Software/020_code-security/` |
