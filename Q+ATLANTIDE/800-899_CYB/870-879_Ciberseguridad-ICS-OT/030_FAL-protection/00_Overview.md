---
document_id: QATL-ATLAS-1000-CYB-870-879-07-030-00-OVERVIEW
title: "CYB 870-879 · 07.030.00 — FAL protection"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "FAL protection"
subsubject: "00"
...
language: en
---
# CYB 870-879 · Section 07 · Subsection 030 — FAL protection

## 1. Purpose

Overview entry-point for the *FAL protection* subsection within the `870-879` code range (Section `07` — *Ciberseguridad ICS/OT*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 870-879.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *FAL protection* slice of the parent code range `870-879`.
...
| Subsection | `030` — FAL protection |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-GROUND |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/870-879_Ciberseguridad-ICS-OT/030_FAL-protection/` |
