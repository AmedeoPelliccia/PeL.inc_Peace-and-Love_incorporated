---
document_id: QATL-ATLAS-1000-CYB-870-879-07-20-00-OVERVIEW
title: "CYB 870-879 · 07.20.00 — industrial control systems"
register: ATLAS-1000
...
language: en
---
# CYB 870-879 · Section 07 · Subsection 20 — industrial control systems
...
This subsubject (`00 Overview`) introduces the CYB 870-879.20.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `20` — industrial control systems |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-INDUSTRY, Q-GROUND |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/870-879_Ciberseguridad-ICS-OT/20_industrial-control-systems/` |
