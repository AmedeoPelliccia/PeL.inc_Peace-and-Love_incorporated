---
document_id: QATL-ATLAS-1000-CYB-890-899-09-030-00-OVERVIEW
title: "CYB 890-899 · 09.030.00 — cyber recovery"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "cyber recovery"
subsubject: "00"
...
language: en
---
# CYB 890-899 · Section 09 · Subsection 030 — cyber recovery

## 1. Purpose

Overview entry-point for the *cyber recovery* subsection within the `890-899` code range (Section `09` — *Inteligencia de Amenazas y Ciber-resiliencia*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 890-899.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *cyber recovery* slice of the parent code range `890-899`.
...
| Subsection | `030` — cyber recovery |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-HORIZON |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/890-899_Inteligencia-de-Amenazas-y-Ciber-resiliencia/030_cyber-recovery/` |
