---
document_id: QATL-ATLAS-1000-CYB-800-809-00-40-00-OVERVIEW
title: "CYB 800-809 · 00.40.00 — policy"
register: ATLAS-1000
...
language: en
---
# CYB 800-809 · Section 00 · Subsection 40 — policy
...
This subsubject (`00 Overview`) introduces the CYB 800-809.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — policy |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-SPACE |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/800-809_Gobernanza-y-Gestion-de-Riesgos-de-Ciberseguridad/40_policy/` |
