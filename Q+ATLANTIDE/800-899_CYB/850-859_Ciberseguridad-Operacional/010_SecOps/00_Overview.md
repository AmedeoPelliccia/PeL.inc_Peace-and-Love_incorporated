---
document_id: QATL-ATLAS-1000-CYB-850-859-05-010-00-OVERVIEW
title: "CYB 850-859 · 05.010.00 — SecOps"
register: ATLAS-1000
...
language: en
---
# CYB 850-859 · Section 05 · Subsection 010 — SecOps

## 1. Purpose

Overview entry-point for the *SecOps* subsection within the `850-859` code range (Section `05` — *Ciberseguridad Operacional*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 850-859.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *SecOps* slice of the parent code range `850-859`.
...
| Subsection | `010` — SecOps |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/850-859_Ciberseguridad-Operacional/010_SecOps/` |
