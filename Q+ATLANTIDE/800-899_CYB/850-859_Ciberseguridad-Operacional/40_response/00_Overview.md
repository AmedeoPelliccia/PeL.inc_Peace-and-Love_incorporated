---
document_id: QATL-ATLAS-1000-CYB-850-859-05-40-00-OVERVIEW
title: "CYB 850-859 · 05.40.00 — response"
register: ATLAS-1000
...
language: en
---
# CYB 850-859 · Section 05 · Subsection 40 — response
...
This subsubject (`00 Overview`) introduces the CYB 850-859.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — response |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC, Q-GROUND |
| ORB support | ORB-PMO, ORB-LEG |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/850-859_Ciberseguridad-Operacional/40_response/` |
