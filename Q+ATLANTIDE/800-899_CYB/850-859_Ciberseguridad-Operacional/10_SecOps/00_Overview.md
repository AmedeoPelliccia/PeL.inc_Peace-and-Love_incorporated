...
Overview of the *SecOps* subsection within the `850-859` code range (Section `05` — Ciberseguridad Operacional) of the CYB architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *SecOps*.

## Scope

- Covers the *SecOps* slice of the parent code range.
