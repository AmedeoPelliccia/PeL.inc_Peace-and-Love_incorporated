---
document_id: QATL-ATLAS-1000-CYB-830-839-03-020-00-OVERVIEW
title: "CYB 830-839 · 03.020.00 — PKI"
register: ATLAS-1000
...
language: en
---
# CYB 830-839 · Section 03 · Subsection 020 — PKI

## 1. Purpose

Overview entry-point for the *PKI* subsection within the `830-839` code range (Section `03` — *Gestión de Identidades y Acceso*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 830-839.020.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *PKI* slice of the parent code range `830-839`.
...
| Folder path | `Q+ATLANTIDE/800-899_CYB/830-839_Gestion-de-Identidades-y-Acceso/020_PKI/` |
