---
document_id: QATL-ATLAS-1000-CYB-830-839-03-030-00-OVERVIEW
title: "CYB 830-839 · 03.030.00 — access control"
register: ATLAS-1000
...
subsection: "030"
subsection_title: "access control"
subsubject: "00"
...
language: en
---
# CYB 830-839 · Section 03 · Subsection 030 — access control

## 1. Purpose

Overview entry-point for the *access control* subsection within the `830-839` code range (Section `03` — *Gestión de Identidades y Acceso*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 830-839.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *access control* slice of the parent code range `830-839`.
...
| Subsection | `030` — access control |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/830-839_Gestion-de-Identidades-y-Acceso/030_access-control/` |
