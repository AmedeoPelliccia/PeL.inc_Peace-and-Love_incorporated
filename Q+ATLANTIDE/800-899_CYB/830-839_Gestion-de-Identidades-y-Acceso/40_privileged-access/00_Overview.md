---
document_id: QATL-ATLAS-1000-CYB-830-839-03-40-00-OVERVIEW
title: "CYB 830-839 · 03.40.00 — privileged access"
register: ATLAS-1000
...
language: en
---
# CYB 830-839 · Section 03 · Subsection 40 — privileged access
...
This subsubject (`00 Overview`) introduces the CYB 830-839.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — privileged access |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/830-839_Gestion-de-Identidades-y-Acceso/40_privileged-access/` |
