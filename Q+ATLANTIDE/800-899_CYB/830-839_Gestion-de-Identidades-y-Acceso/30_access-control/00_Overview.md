---
document_id: QATL-ATLAS-1000-CYB-830-839-03-30-00-OVERVIEW
title: "CYB 830-839 · 03.30.00 — access control"
register: ATLAS-1000
...
language: en
---
# CYB 830-839 · Section 03 · Subsection 30 — access control
...
This subsubject (`00 Overview`) introduces the CYB 830-839.30.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `30` — access control |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-HR |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/830-839_Gestion-de-Identidades-y-Acceso/30_access-control/` |
