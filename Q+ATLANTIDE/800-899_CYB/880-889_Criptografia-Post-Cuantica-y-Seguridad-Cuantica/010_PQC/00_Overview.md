---
document_id: QATL-ATLAS-1000-CYB-880-889-08-010-00-OVERVIEW
title: "CYB 880-889 · 08.010.00 — PQC"
register: ATLAS-1000
...
language: en
---
# CYB 880-889 · Section 08 · Subsection 010 — PQC

## 1. Purpose

Overview entry-point for the *PQC* subsection within the `880-889` code range (Section `08` — *Criptografía Post-Cuántica y Seguridad Cuántica*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 880-889.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *PQC* slice of the parent code range `880-889`.
...
| Folder path | `Q+ATLANTIDE/800-899_CYB/880-889_Criptografia-Post-Cuantica-y-Seguridad-Cuantica/010_PQC/` |
