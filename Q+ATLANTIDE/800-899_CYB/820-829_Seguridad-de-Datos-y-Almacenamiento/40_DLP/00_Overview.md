...
Overview of the *DLP* subsection within the `820-829` code range (Section `02` — Seguridad de Datos y Almacenamiento) of the CYB architecture band.

This subsubject (`00 Overview`) is the entry point for all artefacts, data modules and lifecycle evidence relating to *DLP*.

## Scope

- Covers the *DLP* slice of the parent code range.
