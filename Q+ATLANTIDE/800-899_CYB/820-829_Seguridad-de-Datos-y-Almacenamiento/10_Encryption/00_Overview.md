---
document_id: QATL-ATLAS-1000-CYB-820-829-02-10-00-OVERVIEW
title: "CYB 820-829 · 02.10.00 — Encryption"
register: ATLAS-1000
...
language: en
---
# CYB 820-829 · Section 02 · Subsection 10 — Encryption
...
This subsubject (`00 Overview`) introduces the CYB 820-829.10.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `10` — Encryption |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/820-829_Seguridad-de-Datos-y-Almacenamiento/10_Encryption/` |
