---
document_id: QATL-ATLAS-1000-CYB-810-819-01-030-00-OVERVIEW
title: "CYB 810-819 · 01.030.00 — zero trust"
register: ATLAS-1000
...
language: en
---
# CYB 810-819 · Section 01 · Subsection 030 — zero trust

## 1. Purpose

Overview entry-point for the *zero trust* subsection within the `810-819` code range (Section `01` — *Seguridad de Redes y Comunicaciones*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 810-819.030.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *zero trust* slice of the parent code range `810-819`.
...
| Subsection | `030` — zero trust |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/810-819_Seguridad-de-Redes-y-Comunicaciones/030_zero-trust/` |
