---
document_id: QATL-ATLAS-1000-CYB-810-819-01-010-00-OVERVIEW
title: "CYB 810-819 · 01.010.00 — Network security"
register: ATLAS-1000
...
subsection: "010"
subsection_title: "Network security"
subsubject: "00"
...
language: en
---
# CYB 810-819 · Section 01 · Subsection 010 — Network security

## 1. Purpose

Overview entry-point for the *Network security* subsection within the `810-819` code range (Section `01` — *Seguridad de Redes y Comunicaciones*) of the **CYB** architecture band (*Cybersecurity Architecture*, master range `800–899`).

This subsubject (`00 Overview`) introduces the CYB 810-819.010.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.

## 2. Scope

- Covers the *Network security* slice of the parent code range `810-819`.
...
| Subsection | `010` — Network security |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/810-819_Seguridad-de-Redes-y-Comunicaciones/010_Network-security/` |
...
[^archtable]: **CYB §3 Architecture Table** — [`../../README.md` §3](../../README.md#3-architecture-table). Authoritative source for the `810-819` row (Section `01` — Seguridad de Redes y Comunicaciones, Primary Q-Division Q-DATAGOV).
