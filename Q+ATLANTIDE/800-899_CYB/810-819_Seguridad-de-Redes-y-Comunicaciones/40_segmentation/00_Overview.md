---
document_id: QATL-ATLAS-1000-CYB-810-819-01-40-00-OVERVIEW
title: "CYB 810-819 · 01.40.00 — segmentation"
register: ATLAS-1000
...
language: en
---
# CYB 810-819 · Section 01 · Subsection 40 — segmentation
...
This subsubject (`00 Overview`) introduces the CYB 810-819.40.00 slice and links it to the controlled Q+ATLANTIDE baseline[^baseline] and to the applicable industry standards listed in §4.
...
| Subsection | `40` — segmentation |
| Subsubject | `00` — Overview |
| Primary Q-Division | Q-DATAGOV[^qdiv] |
| Support Q-Divisions | Q-SPACE, Q-HPC |
| ORB support | ORB-LEG, ORB-PMO |
| Governance class | `restricted`[^gov] |
| Folder path | `Q+ATLANTIDE/800-899_CYB/810-819_Seguridad-de-Redes-y-Comunicaciones/40_segmentation/` |
